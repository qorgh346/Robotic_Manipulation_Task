...
//import org.ros.uos.ai.jam.examples.*;
...
//		Object returnedObj = null;
		...
		if (obj instanceof org.ros.uos.ai.jam.plan.action.PrimitiveAction) {
			Value v = ((org.ros.uos.ai.jam.plan.action.PrimitiveAction) obj).execute(_functionName,	_arity, _args, b, currentGoal);
			if (v.eval(b).isTrue()) {
