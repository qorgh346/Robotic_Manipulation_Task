...
void PickPlace::define_joint_values()
{
    ...
    pregrasp_joint_[0] = -1.45;
    pregrasp_joint_[1] = 1.42;
    pregrasp_joint_[2] = 1.10;
    pregrasp_joint_[3] = 0.82;
    pregrasp_joint_[4] = -2.45;
    pregrasp_joint_[5] = 1.05;

    postgrasp_joint_.resize(joint_names_.size());
    postgrasp_joint_[0] = 0.11;
    postgrasp_joint_[1] = 1.70;
    postgrasp_joint_[2] = 1.10;
    postgrasp_joint_[3] = 0.82;
    postgrasp_joint_[4] = -2.45;
    postgrasp_joint_[5] = 1.05;
}
...
bool PickPlace::my_pick()
{
    ...
    ros::WallDuration(1.0).sleep();
    /*
    ROS_INFO_STREAM("Planning to go to init pose ...");
