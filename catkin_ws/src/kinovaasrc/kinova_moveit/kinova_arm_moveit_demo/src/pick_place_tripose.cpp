...
void PickPlace::build_workscene()
{
    ...
    // add table
    co_.primitives.resize(3);
    co_.primitive_poses.resize(3);
    ...
    co_.primitives[0].dimensions[shape_msgs::SolidPrimitive::BOX_X] = 0.2;
    co_.primitives[0].dimensions[shape_msgs::SolidPrimitive::BOX_Y] = 0.4;
    ...
    co_.primitive_poses[0].position.z = 0.2;
    ...
    co_.primitives[1].dimensions[shape_msgs::SolidPrimitive::BOX_X] = 0.4;
    co_.primitives[1].dimensions[shape_msgs::SolidPrimitive::BOX_Y] = 0.2;
    co_.primitives[1].dimensions[shape_msgs::SolidPrimitive::BOX_Z] = 0.4;
    co_.primitive_poses[1].position.x = 0;
    co_.primitive_poses[1].position.y = 0.6;
    co_.primitive_poses[1].position.z = 0.2;
    
    // co_.primitives[2].type = shape_msgs::SolidPrimitive::BOX;
    // co_.primitives[2].dimensions.resize(geometric_shapes::SolidPrimitiveDimCount<shape_msgs::SolidPrimitive::BOX>::value);
    // co_.operation = moveit_msgs::CollisionObject::ADD;

    // co_.primitives[2].dimensions[shape_msgs::SolidPrimitive::BOX_X] = 0.05;
    // co_.primitives[2].dimensions[shape_msgs::SolidPrimitive::BOX_Y] = 0.05;
    // co_.primitives[2].dimensions[shape_msgs::SolidPrimitive::BOX_Z] = 0.2;
    // co_.primitive_poses[2].position.x = 0.6;
    // co_.primitive_poses[2].position.y = 0.0;
    // co_.primitive_poses[2].position.z = 0.5;
...
void PickPlace::define_cartesian_pose()
{
    ...
    start_pose_.pose.position.x = 0.57;
    start_pose_.pose.position.y = 0.0;
    start_pose_.pose.position.z = 0.53;
    ...
    grasp_pose_.pose.position.x = 0.57;
    grasp_pose_.pose.position.y = 0.0;
    grasp_pose_.pose.position.z = 0.53;
...
void PickPlace::define_joint_values()
{
    ...
    pregrasp_joint_[0] = 0.0760 + (hpi * cnt);
    pregrasp_joint_[1] = 1.283189;
    pregrasp_joint_[2] = 0.65792;
    pregrasp_joint_[3] = 1.05628;
    pregrasp_joint_[4] = -2.6904;
    pregrasp_joint_[5] = 1.32525;

    //grasp
    grasp_joint_.resize(joint_names_.size());
    grasp_joint_[0] = 0.0760 + (hpi * cnt);
    grasp_joint_[1] = 1.283189;
    grasp_joint_[2] = 0.95792;
    grasp_joint_[3] = 1.05628;
    grasp_joint_[4] = -2.6904;
    grasp_joint_[5] = 1.32525;

    //postgrasp
    postgrasp_joint_.resize(joint_names_.size());
    postgrasp_joint_[0] = 0.072 + (hpi * cnt);
    postgrasp_joint_[1] = 2.032;
    postgrasp_joint_[2] = 2.681;
    postgrasp_joint_[3] = 0.150;
    postgrasp_joint_[4] = -0.982;
    postgrasp_joint_[5] = 0.4796;

    //release
    release_joint_.resize(joint_names_.size());
    release_joint_[0] = 0.086094 + (hpi * cnt);
    release_joint_[1] = 1.91518;
    release_joint_[2] = 3.0942;
    release_joint_[3] = -0.12145;
    release_joint_[4] = -0.4732;
    release_joint_[5] = 0.4884;

    postrelease_joint_.resize(joint_names_.size());
    postrelease_joint_[0] = 0.103 + (hpi * cnt);
    postrelease_joint_[1] = 1.523;
    postrelease_joint_[2] = 1.357;
    postrelease_joint_[3] = 0.650;
    postrelease_joint_[4] = -2.181;
    postrelease_joint_[5] = 0.8893;
}
...
bool PickPlace::my_pick()
{
    ...
    ROS_INFO_STREAM("Please start simulation on V-rep.");
    ROS_INFO_STREAM("If you ready, press any key...");
    std::cin >> pause_;
    ...
    while (cnt < 2) {
        ...
        group_->setJointValueTarget(postrelease_joint_);
        evaluate_plan(*group_);
