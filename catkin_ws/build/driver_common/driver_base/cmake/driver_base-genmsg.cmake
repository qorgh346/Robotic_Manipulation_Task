...
set(MSG_I_FLAGS "-Idriver_base:/home/test/Downloads/190816_cmtm_code/catkin_ws/src/driver_common/driver_base/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/test/Downloads/190816_cmtm_code/catkin_ws/src/driver_common/driver_base/msg/ConfigValue.msg" NAME_WE)
add_custom_target(_driver_base_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "driver_base" "/home/test/Downloads/190816_cmtm_code/catkin_ws/src/driver_common/driver_base/msg/ConfigValue.msg" ""
)

get_filename_component(_filename "/home/test/Downloads/190816_cmtm_code/catkin_ws/src/driver_common/driver_base/msg/ConfigString.msg" NAME_WE)
add_custom_target(_driver_base_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "driver_base" "/home/test/Downloads/190816_cmtm_code/catkin_ws/src/driver_common/driver_base/msg/ConfigString.msg" ""
)

get_filename_component(_filename "/home/test/Downloads/190816_cmtm_code/catkin_ws/src/driver_common/driver_base/msg/SensorLevels.msg" NAME_WE)
add_custom_target(_driver_base_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "driver_base" "/home/test/Downloads/190816_cmtm_code/catkin_ws/src/driver_common/driver_base/msg/SensorLevels.msg" ""
)
...
### Generating Messages
_generate_msg_java(driver_base
  "/home/test/Downloads/190816_cmtm_code/catkin_ws/src/driver_common/driver_base/msg/ConfigValue.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/driver_base
)
_generate_msg_java(driver_base
  "/home/test/Downloads/190816_cmtm_code/catkin_ws/src/driver_common/driver_base/msg/ConfigString.msg"
  "${MSG_I_FLAGS}"
...
### Generating Module File
_generate_module_java(driver_base
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/driver_base
  "${ALL_GEN_OUTPUT_FILES_java}"
)

add_custom_target(driver_base_generate_messages_java
  DEPENDS ${ALL_GEN_OUTPUT_FILES_java}
)
add_dependencies(driver_base_generate_messages driver_base_generate_messages_java)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/test/Downloads/190816_cmtm_code/catkin_ws/src/driver_common/driver_base/msg/ConfigValue.msg" NAME_WE)
add_dependencies(driver_base_generate_messages_java _driver_base_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/test/Downloads/190816_cmtm_code/catkin_ws/src/driver_common/driver_base/msg/ConfigString.msg" NAME_WE)
add_dependencies(driver_base_generate_messages_java _driver_base_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/test/Downloads/190816_cmtm_code/catkin_ws/src/driver_common/driver_base/msg/SensorLevels.msg" NAME_WE)
add_dependencies(driver_base_generate_messages_java _driver_base_generate_messages_check_deps_${_filename})
...
# target for backward compatibility
add_custom_target(driver_base_genjava)
add_dependencies(driver_base_genjava driver_base_generate_messages_java)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS driver_base_generate_messages_java)
...
if(genjava_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/driver_base)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/driver_base
    DESTINATION ${genjava_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_java)
  add_dependencies(driver_base_generate_messages_java std_msgs_generate_messages_java)
endif()
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/driver_base)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/driver_base\")")
  # install generated code
  install(
