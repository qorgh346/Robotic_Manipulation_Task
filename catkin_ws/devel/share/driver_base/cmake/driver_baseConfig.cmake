...
if("TRUE" STREQUAL "TRUE")
  set(driver_base_SOURCE_PREFIX /home/test/Downloads/190816_cmtm_code/catkin_ws/src/driver_common/driver_base)
  set(driver_base_DEVEL_PREFIX /home/test/Downloads/190816_cmtm_code/catkin_ws/devel)
  ...
  set(driver_base_INSTALL_PREFIX /home/test/Downloads/190816_cmtm_code/catkin_ws/install)
...
if(NOT "/home/test/Downloads/190816_cmtm_code/catkin_ws/devel/include;/home/test/Downloads/190816_cmtm_code/catkin_ws/src/driver_common/driver_base/include;/usr/include " STREQUAL " ")
  set(driver_base_INCLUDE_DIRS "")
  set(_include_dirs "/home/test/Downloads/190816_cmtm_code/catkin_ws/devel/include;/home/test/Downloads/190816_cmtm_code/catkin_ws/src/driver_common/driver_base/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'driver_base' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/test/Downloads/190816_cmtm_code/catkin_ws/src/driver_common/driver_base/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT driver_base_NUM_DUMMY_TARGETS)
      set(driver_base_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::driver_base::wrapped-linker-option${driver_base_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR driver_base_NUM_DUMMY_TARGETS "${driver_base_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::driver_base::wrapped-linker-option${driver_base_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND driver_base_LIBRARIES "${interface_target_name}")
...
set(driver_base_EXPORTED_TARGETS "driver_base_generate_messages_cpp;driver_base_generate_messages_eus;driver_base_generate_messages_java;driver_base_generate_messages_lisp;driver_base_generate_messages_nodejs;driver_base_generate_messages_py")
