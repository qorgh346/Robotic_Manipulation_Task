...
if("TRUE" STREQUAL "TRUE")
  set(timestamp_tools_SOURCE_PREFIX /home/test/Downloads/190816_cmtm_code/catkin_ws/src/driver_common/timestamp_tools)
  set(timestamp_tools_DEVEL_PREFIX /home/test/Downloads/190816_cmtm_code/catkin_ws/devel)
  ...
  set(timestamp_tools_INSTALL_PREFIX /home/test/Downloads/190816_cmtm_code/catkin_ws/install)
...
if(NOT "/home/test/Downloads/190816_cmtm_code/catkin_ws/src/driver_common/timestamp_tools/include " STREQUAL " ")
  set(timestamp_tools_INCLUDE_DIRS "")
  set(_include_dirs "/home/test/Downloads/190816_cmtm_code/catkin_ws/src/driver_common/timestamp_tools/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'timestamp_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/test/Downloads/190816_cmtm_code/catkin_ws/src/driver_common/timestamp_tools/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT timestamp_tools_NUM_DUMMY_TARGETS)
      set(timestamp_tools_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::timestamp_tools::wrapped-linker-option${timestamp_tools_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR timestamp_tools_NUM_DUMMY_TARGETS "${timestamp_tools_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::timestamp_tools::wrapped-linker-option${timestamp_tools_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND timestamp_tools_LIBRARIES "${interface_target_name}")
