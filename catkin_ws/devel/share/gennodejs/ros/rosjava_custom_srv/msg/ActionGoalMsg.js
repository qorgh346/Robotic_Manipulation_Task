...
class ActionGoalMsg {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ActionGoalMsg
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ActionGoalMsg
    let len;
    let data = new ActionGoalMsg(null);
  ...
  static datatype() {
    ...
    return 'rosjava_custom_srv/ActionGoalMsg';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '31a8a01349e4a804908a768499ac37df';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ActionGoalMsg(null);
