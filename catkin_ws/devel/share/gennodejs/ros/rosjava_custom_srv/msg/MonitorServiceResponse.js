...
class MonitorServiceResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MonitorServiceResponse(null);
  ...
  static datatype() {
    ...
    return 'rosjava_custom_srv/MonitorServiceResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MonitorServiceResponse(null);
...
module.exports = MonitorServiceResponse;
