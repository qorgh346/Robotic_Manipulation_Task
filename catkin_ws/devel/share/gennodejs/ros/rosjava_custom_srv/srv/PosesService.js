...
class PosesServiceRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PosesServiceRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PosesServiceRequest
    let len;
    let data = new PosesServiceRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new PosesServiceRequest(null);
...
class PosesServiceResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PosesServiceResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PosesServiceResponse
    let len;
    let data = new PosesServiceResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new PosesServiceResponse(null);
...
module.exports = {
  Request: PosesServiceRequest,
  Response: PosesServiceResponse,
  md5sum() { return 'a243938bf0823a529017bbe4350d96b8'; },
  datatype() { return 'rosjava_custom_srv/PosesService'; }
};
