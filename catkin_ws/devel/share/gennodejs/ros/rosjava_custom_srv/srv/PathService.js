...
let ActionGoalMsg = require('../msg/ActionGoalMsg.js');
...
class PathServiceRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PathServiceRequest
    ...
    bufferOffset = ActionGoalMsg.serialize(obj.param2, buffer, bufferOffset);
    // Serialize message field [param3]
    // Serialize the length for message field [param3]
    bufferOffset = _serializer.uint32(obj.param3.length, buffer, bufferOffset);
    obj.param3.forEach((val) => {
      bufferOffset = ActionGoalMsg.serialize(val, buffer, bufferOffset);
    });
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PathServiceRequest
    let len;
    let data = new PathServiceRequest(null);
    ...
    data.param2 = ActionGoalMsg.deserialize(buffer, bufferOffset);
    // Deserialize message field [param3]
    // Deserialize array length for message field [param3]
    len = _deserializer.uint32(buffer, bufferOffset);
    data.param3 = new Array(len);
    for (let i = 0; i < len; ++i) {
      data.param3[i] = ActionGoalMsg.deserialize(buffer, bufferOffset)
    }
  ...
  static getMessageSize(object) {
    ...
    length += ActionGoalMsg.getMessageSize(object.param2);
    object.param3.forEach((val) => {
      length += ActionGoalMsg.getMessageSize(val);
    });
  ...
  static datatype() {
    ...
    return 'rosjava_custom_srv/PathServiceRequest';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '274b9b2a768f1126a8aed88156fa0cb1';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PathServiceRequest(null);
    ...
    if (msg.param2 !== undefined) {
      resolved.param2 = ActionGoalMsg.Resolve(msg.param2)
    }
    else {
      resolved.param2 = new ActionGoalMsg()
    }

    if (msg.param3 !== undefined) {
      resolved.param3 = new Array(msg.param3.length);
      for (let i = 0; i < resolved.param3.length; ++i) {
        resolved.param3[i] = ActionGoalMsg.Resolve(msg.param3[i]);
      }
    }
    else {
      resolved.param3 = []
...
class PathServiceResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PathServiceResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PathServiceResponse
    let len;
    let data = new PathServiceResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'rosjava_custom_srv/PathServiceResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PathServiceResponse(null);
...
module.exports = {
  Request: PathServiceRequest,
  Response: PathServiceResponse,
  md5sum() { return '61cc47e6afd1df5f5d0b4911e9fe1a32'; },
  datatype() { return 'rosjava_custom_srv/PathService'; }
};
