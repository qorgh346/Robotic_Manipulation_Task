...
let PlanningSceneComponents = require('../msg/PlanningSceneComponents.js');
...
class GetPlanningSceneRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetPlanningSceneRequest
    // Serialize message field [components]
    bufferOffset = PlanningSceneComponents.serialize(obj.components, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetPlanningSceneRequest
    let len;
    let data = new GetPlanningSceneRequest(null);
    // Deserialize message field [components]
    data.components = PlanningSceneComponents.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetPlanningSceneRequest(null);
    if (msg.components !== undefined) {
      resolved.components = PlanningSceneComponents.Resolve(msg.components)
    }
    else {
      resolved.components = new PlanningSceneComponents()
    }
...
class GetPlanningSceneResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.scene = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetPlanningSceneResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetPlanningSceneResponse
    let len;
    let data = new GetPlanningSceneResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'moveit_msgs/GetPlanningSceneResponse';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '7bedc4871b1d0af6ec8b8996db347e7f';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetPlanningSceneResponse(null);
...
module.exports = {
  ...
  md5sum() { return '2745cf315b4eb5fb00e5befa8714d64d'; },
  datatype() { return 'moveit_msgs/GetPlanningScene'; }
};
