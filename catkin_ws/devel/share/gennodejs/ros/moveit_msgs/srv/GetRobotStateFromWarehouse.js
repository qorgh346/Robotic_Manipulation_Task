...
class GetRobotStateFromWarehouseRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetRobotStateFromWarehouseRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetRobotStateFromWarehouseRequest
    let len;
    let data = new GetRobotStateFromWarehouseRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetRobotStateFromWarehouseRequest(null);
...
class GetRobotStateFromWarehouseResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.state = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetRobotStateFromWarehouseResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetRobotStateFromWarehouseResponse
    let len;
    let data = new GetRobotStateFromWarehouseResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'moveit_msgs/GetRobotStateFromWarehouseResponse';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '219fdfe7af6da3c7935fb948e6d5c637';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetRobotStateFromWarehouseResponse(null);
...
module.exports = {
  Request: GetRobotStateFromWarehouseRequest,
  Response: GetRobotStateFromWarehouseResponse,
  md5sum() { return '1e46b17b23bf82bdaafbbc818f6d91b0'; },
  datatype() { return 'moveit_msgs/GetRobotStateFromWarehouse'; }
};
