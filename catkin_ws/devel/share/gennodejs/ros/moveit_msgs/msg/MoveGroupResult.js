...
class MoveGroupResult {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.error_code = null;
      this.trajectory_start = null;
      this.planned_trajectory = null;
      this.executed_trajectory = null;
      ...
      if (initObj.hasOwnProperty('planned_trajectory')) {
        this.planned_trajectory = initObj.planned_trajectory
      }
      else {
        this.planned_trajectory = new RobotTrajectory();
      }
      if (initObj.hasOwnProperty('executed_trajectory')) {
        this.executed_trajectory = initObj.executed_trajectory
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MoveGroupResult
    ...
    // Serialize message field [planned_trajectory]
    bufferOffset = RobotTrajectory.serialize(obj.planned_trajectory, buffer, bufferOffset);
    // Serialize message field [executed_trajectory]
    bufferOffset = RobotTrajectory.serialize(obj.executed_trajectory, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MoveGroupResult
    let len;
    let data = new MoveGroupResult(null);
    ...
    // Deserialize message field [planned_trajectory]
    data.planned_trajectory = RobotTrajectory.deserialize(buffer, bufferOffset);
    // Deserialize message field [executed_trajectory]
    data.executed_trajectory = RobotTrajectory.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += RobotTrajectory.getMessageSize(object.planned_trajectory);
    length += RobotTrajectory.getMessageSize(object.executed_trajectory);
    return length + 12;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveGroupResult(null);
    ...
    if (msg.planned_trajectory !== undefined) {
      resolved.planned_trajectory = RobotTrajectory.Resolve(msg.planned_trajectory)
    }
    else {
      resolved.planned_trajectory = new RobotTrajectory()
    }

    if (msg.executed_trajectory !== undefined) {
      resolved.executed_trajectory = RobotTrajectory.Resolve(msg.executed_trajectory)
    }
    else {
      resolved.executed_trajectory = new RobotTrajectory()
    }
...
module.exports = MoveGroupResult;
