...
class MoveGroupActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MoveGroupActionGoal
    // Serialize message field [header]
    bufferOffset = std_msgs.msg.Header.serialize(obj.header, buffer, bufferOffset);
    // Serialize message field [goal_id]
    bufferOffset = actionlib_msgs.msg.GoalID.serialize(obj.goal_id, buffer, bufferOffset);
    // Serialize message field [goal]
    bufferOffset = MoveGroupGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MoveGroupActionGoal
    let len;
    let data = new MoveGroupActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = MoveGroupGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += MoveGroupGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveGroupActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = MoveGroupGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new MoveGroupGoal()
    }
...
module.exports = MoveGroupActionGoal;
