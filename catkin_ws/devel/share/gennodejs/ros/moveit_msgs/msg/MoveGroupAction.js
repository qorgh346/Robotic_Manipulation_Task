...
class MoveGroupAction {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MoveGroupAction
    // Serialize message field [action_goal]
    bufferOffset = MoveGroupActionGoal.serialize(obj.action_goal, buffer, bufferOffset);
    // Serialize message field [action_result]
    bufferOffset = MoveGroupActionResult.serialize(obj.action_result, buffer, bufferOffset);
    // Serialize message field [action_feedback]
    bufferOffset = MoveGroupActionFeedback.serialize(obj.action_feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MoveGroupAction
    let len;
    let data = new MoveGroupAction(null);
    // Deserialize message field [action_goal]
    data.action_goal = MoveGroupActionGoal.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_result]
    data.action_result = MoveGroupActionResult.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_feedback]
    data.action_feedback = MoveGroupActionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += MoveGroupActionGoal.getMessageSize(object.action_goal);
    length += MoveGroupActionResult.getMessageSize(object.action_result);
    length += MoveGroupActionFeedback.getMessageSize(object.action_feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveGroupAction(null);
    if (msg.action_goal !== undefined) {
      resolved.action_goal = MoveGroupActionGoal.Resolve(msg.action_goal)
    }
    else {
      resolved.action_goal = new MoveGroupActionGoal()
    }

    if (msg.action_result !== undefined) {
      resolved.action_result = MoveGroupActionResult.Resolve(msg.action_result)
    }
    else {
      resolved.action_result = new MoveGroupActionResult()
    }

    if (msg.action_feedback !== undefined) {
      resolved.action_feedback = MoveGroupActionFeedback.Resolve(msg.action_feedback)
    }
    else {
      resolved.action_feedback = new MoveGroupActionFeedback()
    }
...
module.exports = MoveGroupAction;
