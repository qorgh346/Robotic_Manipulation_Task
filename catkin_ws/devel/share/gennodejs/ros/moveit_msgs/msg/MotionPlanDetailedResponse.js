...
class MotionPlanDetailedResponse {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.float64(obj.processing_time, buffer, bufferOffset, null);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MotionPlanDetailedResponse(null);
    ...
    data.processing_time = _arrayDeserializer.float64(buffer, bufferOffset, null)
  ...
  static getMessageSize(object) {
    ...
    length += 8 * object.processing_time.length;
    return length + 20;
  }
  ...
  static md5sum() {
    ...
    return '7b84c374bb2e37bdc0eba664f7636a8f';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MotionPlanDetailedResponse(null);
...
module.exports = MotionPlanDetailedResponse;
