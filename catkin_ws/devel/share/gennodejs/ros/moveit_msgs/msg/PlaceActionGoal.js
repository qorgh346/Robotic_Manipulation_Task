...
class PlaceActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PlaceGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PlaceGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlaceActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = PlaceGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new PlaceGoal()
    }
...
module.exports = PlaceActionGoal;
