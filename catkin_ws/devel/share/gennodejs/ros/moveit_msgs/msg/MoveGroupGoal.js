...
class MoveGroupGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MoveGroupGoal
    // Serialize message field [request]
    bufferOffset = MotionPlanRequest.serialize(obj.request, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MoveGroupGoal
    let len;
    let data = new MoveGroupGoal(null);
    // Deserialize message field [request]
    data.request = MotionPlanRequest.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += MotionPlanRequest.getMessageSize(object.request);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveGroupGoal(null);
    if (msg.request !== undefined) {
      resolved.request = MotionPlanRequest.Resolve(msg.request)
    }
    else {
      resolved.request = new MotionPlanRequest()
    }
