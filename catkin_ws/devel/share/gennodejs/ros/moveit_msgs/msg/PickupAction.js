...
class PickupAction {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PickupActionGoal.serialize(obj.action_goal, buffer, bufferOffset);
    // Serialize message field [action_result]
    bufferOffset = PickupActionResult.serialize(obj.action_result, buffer, bufferOffset);
    // Serialize message field [action_feedback]
    bufferOffset = PickupActionFeedback.serialize(obj.action_feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PickupAction(null);
    // Deserialize message field [action_goal]
    data.action_goal = PickupActionGoal.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_result]
    data.action_result = PickupActionResult.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_feedback]
    data.action_feedback = PickupActionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += PickupActionGoal.getMessageSize(object.action_goal);
    length += PickupActionResult.getMessageSize(object.action_result);
    length += PickupActionFeedback.getMessageSize(object.action_feedback);
    return length;
  }
  ...
  static md5sum() {
    ...
    return 'f5aa574f57e5d9cf7d466d5913039489';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PickupAction(null);
    if (msg.action_goal !== undefined) {
      resolved.action_goal = PickupActionGoal.Resolve(msg.action_goal)
    }
    else {
      resolved.action_goal = new PickupActionGoal()
    }

    if (msg.action_result !== undefined) {
      resolved.action_result = PickupActionResult.Resolve(msg.action_result)
    }
    else {
      resolved.action_result = new PickupActionResult()
    }

    if (msg.action_feedback !== undefined) {
      resolved.action_feedback = PickupActionFeedback.Resolve(msg.action_feedback)
    }
    else {
      resolved.action_feedback = new PickupActionFeedback()
    }
