...
class PlanningOptions {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.planning_scene_diff = null;
      this.plan_only = null;
      this.look_around = null;
      this.look_around_attempts = null;
      this.max_safe_execution_cost = null;
      this.replan = null;
      this.replan_attempts = null;
      this.replan_delay = null;
    }
    else {
      if (initObj.hasOwnProperty('planning_scene_diff')) {
        this.planning_scene_diff = initObj.planning_scene_diff
      }
      else {
      ...
      if (initObj.hasOwnProperty('look_around')) {
        this.look_around = initObj.look_around
      }
      else {
        this.look_around = false;
      }
      if (initObj.hasOwnProperty('look_around_attempts')) {
        this.look_around_attempts = initObj.look_around_attempts
      }
      else {
        this.look_around_attempts = 0;
      }
      if (initObj.hasOwnProperty('max_safe_execution_cost')) {
        this.max_safe_execution_cost = initObj.max_safe_execution_cost
      }
      else {
      ...
      if (initObj.hasOwnProperty('replan_attempts')) {
        this.replan_attempts = initObj.replan_attempts
      }
      else {
        this.replan_attempts = 0;
      }
      if (initObj.hasOwnProperty('replan_delay')) {
        this.replan_delay = initObj.replan_delay
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PlanningOptions
    // Serialize message field [planning_scene_diff]
    bufferOffset = PlanningScene.serialize(obj.planning_scene_diff, buffer, bufferOffset);
    // Serialize message field [plan_only]
    bufferOffset = _serializer.bool(obj.plan_only, buffer, bufferOffset);
    // Serialize message field [look_around]
    bufferOffset = _serializer.bool(obj.look_around, buffer, bufferOffset);
    // Serialize message field [look_around_attempts]
    bufferOffset = _serializer.int32(obj.look_around_attempts, buffer, bufferOffset);
    // Serialize message field [max_safe_execution_cost]
    bufferOffset = _serializer.float64(obj.max_safe_execution_cost, buffer, bufferOffset);
    // Serialize message field [replan]
    bufferOffset = _serializer.bool(obj.replan, buffer, bufferOffset);
    // Serialize message field [replan_attempts]
    bufferOffset = _serializer.int32(obj.replan_attempts, buffer, bufferOffset);
    // Serialize message field [replan_delay]
    bufferOffset = _serializer.float64(obj.replan_delay, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PlanningOptions
    let len;
    let data = new PlanningOptions(null);
    // Deserialize message field [planning_scene_diff]
    data.planning_scene_diff = PlanningScene.deserialize(buffer, bufferOffset);
    // Deserialize message field [plan_only]
    data.plan_only = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [look_around]
    data.look_around = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [look_around_attempts]
    data.look_around_attempts = _deserializer.int32(buffer, bufferOffset);
    // Deserialize message field [max_safe_execution_cost]
    data.max_safe_execution_cost = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [replan]
    data.replan = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [replan_attempts]
    data.replan_attempts = _deserializer.int32(buffer, bufferOffset);
    // Deserialize message field [replan_delay]
    data.replan_delay = _deserializer.float64(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += PlanningScene.getMessageSize(object.planning_scene_diff);
    return length + 27;
  }
  ...
  static md5sum() {
    ...
    return '3934e50ede2ecea03e532aade900ab50';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlanningOptions(null);
    if (msg.planning_scene_diff !== undefined) {
      resolved.planning_scene_diff = PlanningScene.Resolve(msg.planning_scene_diff)
    }
    else {
      resolved.planning_scene_diff = new PlanningScene()
    }
    ...
    if (msg.look_around !== undefined) {
      resolved.look_around = msg.look_around;
    }
    else {
      resolved.look_around = false
    }

    if (msg.look_around_attempts !== undefined) {
      resolved.look_around_attempts = msg.look_around_attempts;
    }
    else {
      resolved.look_around_attempts = 0
    }

    if (msg.max_safe_execution_cost !== undefined) {
      resolved.max_safe_execution_cost = msg.max_safe_execution_cost;
    }
    else {
      resolved.max_safe_execution_cost = 0.0
    }
    ...
    if (msg.replan_attempts !== undefined) {
      resolved.replan_attempts = msg.replan_attempts;
    }
    else {
      resolved.replan_attempts = 0
    }

    if (msg.replan_delay !== undefined) {
      resolved.replan_delay = msg.replan_delay;
    }
    else {
      resolved.replan_delay = 0.0
    }
...
module.exports = PlanningOptions;
