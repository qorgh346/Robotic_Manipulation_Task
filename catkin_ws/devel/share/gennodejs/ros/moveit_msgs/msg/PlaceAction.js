...
class PlaceAction {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PlaceAction
    // Serialize message field [action_goal]
    bufferOffset = PlaceActionGoal.serialize(obj.action_goal, buffer, bufferOffset);
    // Serialize message field [action_result]
    bufferOffset = PlaceActionResult.serialize(obj.action_result, buffer, bufferOffset);
    // Serialize message field [action_feedback]
    bufferOffset = PlaceActionFeedback.serialize(obj.action_feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PlaceAction
    let len;
    let data = new PlaceAction(null);
    // Deserialize message field [action_goal]
    data.action_goal = PlaceActionGoal.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_result]
    data.action_result = PlaceActionResult.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_feedback]
    data.action_feedback = PlaceActionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += PlaceActionGoal.getMessageSize(object.action_goal);
    length += PlaceActionResult.getMessageSize(object.action_result);
    length += PlaceActionFeedback.getMessageSize(object.action_feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlaceAction(null);
    if (msg.action_goal !== undefined) {
      resolved.action_goal = PlaceActionGoal.Resolve(msg.action_goal)
    }
    else {
      resolved.action_goal = new PlaceActionGoal()
    }

    if (msg.action_result !== undefined) {
      resolved.action_result = PlaceActionResult.Resolve(msg.action_result)
    }
    else {
      resolved.action_result = new PlaceActionResult()
    }

    if (msg.action_feedback !== undefined) {
      resolved.action_feedback = PlaceActionFeedback.Resolve(msg.action_feedback)
    }
    else {
      resolved.action_feedback = new PlaceActionFeedback()
    }
