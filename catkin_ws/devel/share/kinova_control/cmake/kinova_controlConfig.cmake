...
if("TRUE" STREQUAL "TRUE")
  set(kinova_control_SOURCE_PREFIX /home/test/Downloads/190816_cmtm_code/catkin_ws/src/kinovaasrc/kinova_control)
  set(kinova_control_DEVEL_PREFIX /home/test/Downloads/190816_cmtm_code/catkin_ws/devel)
  ...
  set(kinova_control_INSTALL_PREFIX /home/test/Downloads/190816_cmtm_code/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kinova_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/test/Downloads/190816_cmtm_code/catkin_ws/src/kinovaasrc/kinova_control/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT kinova_control_NUM_DUMMY_TARGETS)
      set(kinova_control_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::kinova_control::wrapped-linker-option${kinova_control_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR kinova_control_NUM_DUMMY_TARGETS "${kinova_control_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::kinova_control::wrapped-linker-option${kinova_control_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND kinova_control_LIBRARIES "${interface_target_name}")
