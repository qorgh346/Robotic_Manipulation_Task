...
;//! \htmlinclude PosesService-request.msg.html

(cl:defclass <PosesService-request> (roslisp-msg-protocol:ros-message)
  ((predicate
    :reader predicate
    :initarg :predicate
    :type cl:string
...
(cl:defclass PosesService-request (<PosesService-request>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <PosesService-request>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'PosesService-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosjava_custom_srv-srv:<PosesService-request> is deprecated: use rosjava_custom_srv-srv:PosesService-request instead.")))

(cl:ensure-generic-function 'predicate-val :lambda-list '(m))
(cl:defmethod predicate-val ((m <PosesService-request>))
...
(cl:defmethod param1-val ((m <PosesService-request>))
...
(cl:defmethod param2-val ((m <PosesService-request>))
...
(cl:defmethod param3-val ((m <PosesService-request>))
...
(cl:defmethod param4-val ((m <PosesService-request>))
  ...
  (param4 m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <PosesService-request>) ostream)
  "Serializes a message object of type '<PosesService-request>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PosesService-request>) istream)
  "Deserializes a message object of type '<PosesService-request>"
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <PosesService-request>))
  "Converts a ROS message object to a list"
  (cl:list 'PosesService-request
...
;//! \htmlinclude PosesService-response.msg.html

(cl:defclass <PosesService-response> (roslisp-msg-protocol:ros-message)
  ((result
    :reader result
    :initarg :result
    :type cl:integer
...
(cl:defclass PosesService-response (<PosesService-response>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <PosesService-response>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'PosesService-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosjava_custom_srv-srv:<PosesService-response> is deprecated: use rosjava_custom_srv-srv:PosesService-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <PosesService-response>))
  ...
  (result m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <PosesService-response>) ostream)
  "Serializes a message object of type '<PosesService-response>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PosesService-response>) istream)
  "Deserializes a message object of type '<PosesService-response>"
    (cl:let ((unsigned 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PosesService-response>)))
  "Returns string type for a service object of type '<PosesService-response>"
  "rosjava_custom_srv/PosesServiceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PosesService-response)))
  "Returns string type for a service object of type 'PosesService-response"
  "rosjava_custom_srv/PosesServiceResponse")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<PosesService-response>)))
  "Returns md5sum for a message object of type '<PosesService-response>"
  "a243938bf0823a529017bbe4350d96b8")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'PosesService-response)))
  "Returns md5sum for a message object of type 'PosesService-response"
  "a243938bf0823a529017bbe4350d96b8")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PosesService-response>)))
  "Returns full string definition for message of type '<PosesService-response>"
  (cl:format cl:nil "int32 result~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PosesService-response)))
  "Returns full string definition for message of type 'PosesService-response"
  (cl:format cl:nil "int32 result~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <PosesService-response>))
  (cl:+ 0
     4
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <PosesService-response>))
  "Converts a ROS message object to a list"
  (cl:list 'PosesService-response
    (cl:cons ':result (result msg))
))
(cl:defmethod roslisp-msg-protocol:service-request-type ((msg (cl:eql 'PosesService)))
  'PosesService-request)
(cl:defmethod roslisp-msg-protocol:service-response-type ((msg (cl:eql 'PosesService)))
  'PosesService-response)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PosesService)))
  "Returns string type for a service object of type '<PosesService>"
  "rosjava_custom_srv/PosesService")