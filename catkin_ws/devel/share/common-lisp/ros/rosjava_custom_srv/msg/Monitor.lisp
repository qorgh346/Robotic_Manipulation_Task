...
(cl:defmethod cl:initialize-instance :after ((m <Monitor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Monitor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosjava_custom_srv-msg:<Monitor> is deprecated: use rosjava_custom_srv-msg:Monitor instead.")))

(cl:ensure-generic-function 'predicate-val :lambda-list '(m))
(cl:defmethod predicate-val ((m <Monitor>))
...
(cl:defmethod param1-val ((m <Monitor>))
...
(cl:defmethod param2-val ((m <Monitor>))
...
(cl:defmethod param3-val ((m <Monitor>))
...
(cl:defmethod param4-val ((m <Monitor>))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Monitor>)))
  ...
  (cl:format cl:nil "string predicate~%string param1~%string param2~%string param3~%string param4~%~%int32 status~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Monitor)))
  "Returns full string definition for message of type 'Monitor"
  (cl:format cl:nil "string predicate~%string param1~%string param2~%string param3~%string param4~%~%int32 status~%~%"))
