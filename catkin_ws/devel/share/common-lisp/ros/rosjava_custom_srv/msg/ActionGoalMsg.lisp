...
(cl:defclass <ActionGoalMsg> (roslisp-msg-protocol:ros-message)
  ((targetBody
    :reader targetBody
    :initarg :targetBody
    :type cl:integer
...
(cl:defclass ActionGoalMsg (<ActionGoalMsg>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ActionGoalMsg>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ActionGoalMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosjava_custom_srv-msg:<ActionGoalMsg> is deprecated: use rosjava_custom_srv-msg:ActionGoalMsg instead.")))

(cl:ensure-generic-function 'targetBody-val :lambda-list '(m))
(cl:defmethod targetBody-val ((m <ActionGoalMsg>))
...
(cl:defmethod actionType-val ((m <ActionGoalMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosjava_custom_srv-msg:actionType-val is deprecated.  Use rosjava_custom_srv-msg:actionType instead.")
  (actionType m))

(cl:ensure-generic-function 'object-val :lambda-list '(m))
(cl:defmethod object-val ((m <ActionGoalMsg>))
...
(cl:defmethod joint_constraints-val ((m <ActionGoalMsg>))
...
(cl:defmethod position_constraints-val ((m <ActionGoalMsg>))
...
(cl:defmethod orientation_constraints-val ((m <ActionGoalMsg>))
...
(cl:defmethod visibility_constraints-val ((m <ActionGoalMsg>))
...
(cl:defmethod targetPose-val ((m <ActionGoalMsg>))
...
(cl:defmethod targetJointState-val ((m <ActionGoalMsg>))
  ...
  (targetJointState m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ActionGoalMsg>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ActionGoalMsg>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ActionGoalMsg>))
  "Converts a ROS message object to a list"
  (cl:list 'ActionGoalMsg
