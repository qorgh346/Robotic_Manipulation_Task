...
;//! \htmlinclude MonitorServiceRequest.msg.html

(cl:defclass <MonitorServiceRequest> (roslisp-msg-protocol:ros-message)
  ((predicate
    :reader predicate
    :initarg :predicate
    :type cl:string
...
(cl:defclass MonitorServiceRequest (<MonitorServiceRequest>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <MonitorServiceRequest>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'MonitorServiceRequest)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosjava_custom_srv-msg:<MonitorServiceRequest> is deprecated: use rosjava_custom_srv-msg:MonitorServiceRequest instead.")))

(cl:ensure-generic-function 'predicate-val :lambda-list '(m))
(cl:defmethod predicate-val ((m <MonitorServiceRequest>))
...
(cl:defmethod param1-val ((m <MonitorServiceRequest>))
...
(cl:defmethod param2-val ((m <MonitorServiceRequest>))
...
(cl:defmethod param3-val ((m <MonitorServiceRequest>))
...
(cl:defmethod param4-val ((m <MonitorServiceRequest>))
...
(cl:defmethod status-val ((m <MonitorServiceRequest>))
...
(cl:defmethod manager-val ((m <MonitorServiceRequest>))
  ...
  (manager m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MonitorServiceRequest>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MonitorServiceRequest>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MonitorServiceRequest>)))
  "Returns string type for a message object of type '<MonitorServiceRequest>"
  "rosjava_custom_srv/MonitorServiceRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MonitorServiceRequest)))
  "Returns string type for a message object of type 'MonitorServiceRequest"
  "rosjava_custom_srv/MonitorServiceRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MonitorServiceRequest>)))
  "Returns md5sum for a message object of type '<MonitorServiceRequest>"
  "b8ba3e44b28132447b0a2a6a1386de5d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MonitorServiceRequest)))
  "Returns md5sum for a message object of type 'MonitorServiceRequest"
  "b8ba3e44b28132447b0a2a6a1386de5d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MonitorServiceRequest>)))
  "Returns full string definition for message of type '<MonitorServiceRequest>"
  (cl:format cl:nil "string predicate~%string param1~%string param2~%string param3~%string param4~%~%int32 status~%string manager~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MonitorServiceRequest)))
  "Returns full string definition for message of type 'MonitorServiceRequest"
  (cl:format cl:nil "string predicate~%string param1~%string param2~%string param3~%string param4~%~%int32 status~%string manager~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <MonitorServiceRequest>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <MonitorServiceRequest>))
  "Converts a ROS message object to a list"
  (cl:list 'MonitorServiceRequest
