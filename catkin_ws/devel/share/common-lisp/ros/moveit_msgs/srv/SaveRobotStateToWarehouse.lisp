...
;//! \htmlinclude SaveRobotStateToWarehouse-request.msg.html

(cl:defclass <SaveRobotStateToWarehouse-request> (roslisp-msg-protocol:ros-message)
  ((name
    :reader name
    :initarg :name
    :type cl:string
...
(cl:defclass SaveRobotStateToWarehouse-request (<SaveRobotStateToWarehouse-request>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <SaveRobotStateToWarehouse-request>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'SaveRobotStateToWarehouse-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name moveit_msgs-srv:<SaveRobotStateToWarehouse-request> is deprecated: use moveit_msgs-srv:SaveRobotStateToWarehouse-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <SaveRobotStateToWarehouse-request>))
...
(cl:defmethod robot-val ((m <SaveRobotStateToWarehouse-request>))
...
(cl:defmethod state-val ((m <SaveRobotStateToWarehouse-request>))
  ...
  (state m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SaveRobotStateToWarehouse-request>) ostream)
  "Serializes a message object of type '<SaveRobotStateToWarehouse-request>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SaveRobotStateToWarehouse-request>) istream)
  "Deserializes a message object of type '<SaveRobotStateToWarehouse-request>"
...
(cl:defclass SaveRobotStateToWarehouse-response (<SaveRobotStateToWarehouse-response>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <SaveRobotStateToWarehouse-response>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'SaveRobotStateToWarehouse-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name moveit_msgs-srv:<SaveRobotStateToWarehouse-response> is deprecated: use moveit_msgs-srv:SaveRobotStateToWarehouse-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SaveRobotStateToWarehouse-response>))
  ...
  (success m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SaveRobotStateToWarehouse-response>) ostream)
  "Serializes a message object of type '<SaveRobotStateToWarehouse-response>"
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'success) 1 0)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SaveRobotStateToWarehouse-response>) istream)
  "Deserializes a message object of type '<SaveRobotStateToWarehouse-response>"
    (cl:setf (cl:slot-value msg 'success) (cl:not (cl:zerop (cl:read-byte istream))))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SaveRobotStateToWarehouse-response>)))
  "Returns string type for a service object of type '<SaveRobotStateToWarehouse-response>"
  "moveit_msgs/SaveRobotStateToWarehouseResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SaveRobotStateToWarehouse-response)))
  "Returns string type for a service object of type 'SaveRobotStateToWarehouse-response"
  "moveit_msgs/SaveRobotStateToWarehouseResponse")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SaveRobotStateToWarehouse-response>)))
  "Returns md5sum for a message object of type '<SaveRobotStateToWarehouse-response>"
  "555cb479e433361a8f0a29f1cd7f3ad2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SaveRobotStateToWarehouse-response)))
  "Returns md5sum for a message object of type 'SaveRobotStateToWarehouse-response"
  "555cb479e433361a8f0a29f1cd7f3ad2")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SaveRobotStateToWarehouse-response>)))
  "Returns full string definition for message of type '<SaveRobotStateToWarehouse-response>"
  (cl:format cl:nil "~%bool success~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SaveRobotStateToWarehouse-response)))
  "Returns full string definition for message of type 'SaveRobotStateToWarehouse-response"
  (cl:format cl:nil "~%bool success~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <SaveRobotStateToWarehouse-response>))
  (cl:+ 0
     1
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SaveRobotStateToWarehouse-response>))
  "Converts a ROS message object to a list"
  (cl:list 'SaveRobotStateToWarehouse-response
    (cl:cons ':success (success msg))
))
(cl:defmethod roslisp-msg-protocol:service-request-type ((msg (cl:eql 'SaveRobotStateToWarehouse)))
  'SaveRobotStateToWarehouse-request)
(cl:defmethod roslisp-msg-protocol:service-response-type ((msg (cl:eql 'SaveRobotStateToWarehouse)))
  'SaveRobotStateToWarehouse-response)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SaveRobotStateToWarehouse)))
  "Returns string type for a service object of type '<SaveRobotStateToWarehouse>"
