...
if("TRUE" STREQUAL "TRUE")
  set(kinova_driver_SOURCE_PREFIX /home/test/Downloads/190816_cmtm_code/catkin_ws/src/kinovaasrc/kinova_driver)
  set(kinova_driver_DEVEL_PREFIX /home/test/Downloads/190816_cmtm_code/catkin_ws/devel)
  ...
  set(kinova_driver_INSTALL_PREFIX /home/test/Downloads/190816_cmtm_code/catkin_ws/install)
...
if(NOT "/home/test/Downloads/190816_cmtm_code/catkin_ws/devel/include;/home/test/Downloads/190816_cmtm_code/catkin_ws/src/kinovaasrc/kinova_driver/include " STREQUAL " ")
  set(kinova_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/test/Downloads/190816_cmtm_code/catkin_ws/devel/include;/home/test/Downloads/190816_cmtm_code/catkin_ws/src/kinovaasrc/kinova_driver/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kinova_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/test/Downloads/190816_cmtm_code/catkin_ws/src/kinovaasrc/kinova_driver/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT kinova_driver_NUM_DUMMY_TARGETS)
      set(kinova_driver_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::kinova_driver::wrapped-linker-option${kinova_driver_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR kinova_driver_NUM_DUMMY_TARGETS "${kinova_driver_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::kinova_driver::wrapped-linker-option${kinova_driver_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND kinova_driver_LIBRARIES "${interface_target_name}")
