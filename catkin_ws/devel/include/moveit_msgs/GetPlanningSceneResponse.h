// Generated by gencpp from file moveit_msgs/GetPlanningSceneResponse.msg
// DO NOT EDIT!


#ifndef MOVEIT_MSGS_MESSAGE_GETPLANNINGSCENERESPONSE_H
#define MOVEIT_MSGS_MESSAGE_GETPLANNINGSCENERESPONSE_H
...
struct GetPlanningSceneResponse_
{
  ...
  typedef boost::shared_ptr< ::moveit_msgs::GetPlanningSceneResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::moveit_msgs::GetPlanningSceneResponse_<ContainerAllocator> const> ConstPtr;

}; // struct GetPlanningSceneResponse_

typedef ::moveit_msgs::GetPlanningSceneResponse_<std::allocator<void> > GetPlanningSceneResponse;

typedef boost::shared_ptr< ::moveit_msgs::GetPlanningSceneResponse > GetPlanningSceneResponsePtr;
typedef boost::shared_ptr< ::moveit_msgs::GetPlanningSceneResponse const> GetPlanningSceneResponseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::moveit_msgs::GetPlanningSceneResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::moveit_msgs::GetPlanningSceneResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::GetPlanningSceneResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::GetPlanningSceneResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::GetPlanningSceneResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::GetPlanningSceneResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::GetPlanningSceneResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::GetPlanningSceneResponse_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::moveit_msgs::GetPlanningSceneResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::moveit_msgs::GetPlanningSceneResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x7bedc4871b1d0af6ULL;
  static const uint64_t static_value2 = 0xec8b8996db347e7fULL;
};

template<class ContainerAllocator>
struct DataType< ::moveit_msgs::GetPlanningSceneResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::moveit_msgs::GetPlanningSceneResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::moveit_msgs::GetPlanningSceneResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::moveit_msgs::GetPlanningSceneResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::moveit_msgs::GetPlanningSceneResponse_<ContainerAllocator>& v)
  {
    s << indent << "scene: ";
    s << std::endl;
...
#endif // MOVEIT_MSGS_MESSAGE_GETPLANNINGSCENERESPONSE_H
