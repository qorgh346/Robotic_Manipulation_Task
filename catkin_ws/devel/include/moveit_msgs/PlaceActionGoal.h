// Generated by gencpp from file moveit_msgs/PlaceActionGoal.msg
// DO NOT EDIT!


#ifndef MOVEIT_MSGS_MESSAGE_PLACEACTIONGOAL_H
#define MOVEIT_MSGS_MESSAGE_PLACEACTIONGOAL_H
...
struct PlaceActionGoal_
{
  ...
  _goal_id_type goal_id;
   ...
   typedef  ::moveit_msgs::PlaceGoal_<ContainerAllocator>  _goal_type;
  _goal_type goal;
  ...
  typedef boost::shared_ptr< ::moveit_msgs::PlaceActionGoal_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::moveit_msgs::PlaceActionGoal_<ContainerAllocator> const> ConstPtr;

}; // struct PlaceActionGoal_

typedef ::moveit_msgs::PlaceActionGoal_<std::allocator<void> > PlaceActionGoal;

typedef boost::shared_ptr< ::moveit_msgs::PlaceActionGoal > PlaceActionGoalPtr;
typedef boost::shared_ptr< ::moveit_msgs::PlaceActionGoal const> PlaceActionGoalConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::moveit_msgs::PlaceActionGoal_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::moveit_msgs::PlaceActionGoal_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::PlaceActionGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::PlaceActionGoal_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::PlaceActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::PlaceActionGoal_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::PlaceActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::PlaceActionGoal_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::moveit_msgs::PlaceActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "facadaee390f685ed5e693ac12f5aa3d";
  }

  static const char* value(const ::moveit_msgs::PlaceActionGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xfacadaee390f685eULL;
  static const uint64_t static_value2 = 0xd5e693ac12f5aa3dULL;
};

template<class ContainerAllocator>
struct DataType< ::moveit_msgs::PlaceActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "moveit_msgs/PlaceActionGoal";
  }
...
template<class ContainerAllocator>
struct Definition< ::moveit_msgs::PlaceActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::moveit_msgs::PlaceActionGoal_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::moveit_msgs::PlaceActionGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::moveit_msgs::PlaceActionGoal_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "goal: ";
    s << std::endl;
    Printer< ::moveit_msgs::PlaceGoal_<ContainerAllocator> >::stream(s, indent + "  ", v.goal);
  }
};
...
#endif // MOVEIT_MSGS_MESSAGE_PLACEACTIONGOAL_H
