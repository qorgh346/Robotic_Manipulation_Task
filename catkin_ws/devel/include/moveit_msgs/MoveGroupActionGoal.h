// Generated by gencpp from file moveit_msgs/MoveGroupActionGoal.msg
// DO NOT EDIT!


#ifndef MOVEIT_MSGS_MESSAGE_MOVEGROUPACTIONGOAL_H
#define MOVEIT_MSGS_MESSAGE_MOVEGROUPACTIONGOAL_H
...
struct MoveGroupActionGoal_
{
  typedef MoveGroupActionGoal_<ContainerAllocator> Type;

  MoveGroupActionGoal_()
    : header()
    , goal_id()
    , goal()  {
    }
  MoveGroupActionGoal_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , goal_id(_alloc)
    , goal(_alloc)  {
  (void)_alloc;
  ...
  _goal_id_type goal_id;
   ...
   typedef  ::moveit_msgs::MoveGroupGoal_<ContainerAllocator>  _goal_type;
  _goal_type goal;
  ...
  typedef boost::shared_ptr< ::moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> const> ConstPtr;

}; // struct MoveGroupActionGoal_

typedef ::moveit_msgs::MoveGroupActionGoal_<std::allocator<void> > MoveGroupActionGoal;

typedef boost::shared_ptr< ::moveit_msgs::MoveGroupActionGoal > MoveGroupActionGoalPtr;
typedef boost::shared_ptr< ::moveit_msgs::MoveGroupActionGoal const> MoveGroupActionGoalConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "df11ac1a643d87b6e6a6fe5af1823709";
  }

  static const char* value(const ::moveit_msgs::MoveGroupActionGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xdf11ac1a643d87b6ULL;
  static const uint64_t static_value2 = 0xe6a6fe5af1823709ULL;
};

template<class ContainerAllocator>
struct DataType< ::moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "moveit_msgs/MoveGroupActionGoal";
  }
...
template<class ContainerAllocator>
struct Definition< ::moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> >
{
...
#endif // MOVEIT_MSGS_MESSAGE_MOVEGROUPACTIONGOAL_H
