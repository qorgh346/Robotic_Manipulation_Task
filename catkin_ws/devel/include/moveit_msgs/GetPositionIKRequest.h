// Generated by gencpp from file moveit_msgs/GetPositionIKRequest.msg
// DO NOT EDIT!


#ifndef MOVEIT_MSGS_MESSAGE_GETPOSITIONIKREQUEST_H
#define MOVEIT_MSGS_MESSAGE_GETPOSITIONIKREQUEST_H
...
struct GetPositionIKRequest_
{
  ...
  (void)_alloc;
   ...
   typedef  ::moveit_msgs::PositionIKRequest_<ContainerAllocator>  _ik_request_type;
  ...
  typedef boost::shared_ptr< ::moveit_msgs::GetPositionIKRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::moveit_msgs::GetPositionIKRequest_<ContainerAllocator> const> ConstPtr;

}; // struct GetPositionIKRequest_

typedef ::moveit_msgs::GetPositionIKRequest_<std::allocator<void> > GetPositionIKRequest;

typedef boost::shared_ptr< ::moveit_msgs::GetPositionIKRequest > GetPositionIKRequestPtr;
typedef boost::shared_ptr< ::moveit_msgs::GetPositionIKRequest const> GetPositionIKRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::moveit_msgs::GetPositionIKRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::moveit_msgs::GetPositionIKRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::GetPositionIKRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::GetPositionIKRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::GetPositionIKRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::GetPositionIKRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::GetPositionIKRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::GetPositionIKRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::moveit_msgs::GetPositionIKRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::moveit_msgs::GetPositionIKRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa67dc7e99d15c1dcULL;
  static const uint64_t static_value2 = 0xa32a77c22bc2d93bULL;
};

template<class ContainerAllocator>
struct DataType< ::moveit_msgs::GetPositionIKRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::moveit_msgs::GetPositionIKRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::moveit_msgs::GetPositionIKRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::moveit_msgs::GetPositionIKRequest_<ContainerAllocator> >
{
...
#endif // MOVEIT_MSGS_MESSAGE_GETPOSITIONIKREQUEST_H
