// Generated by gencpp from file moveit_msgs/MoveGroupAction.msg
// DO NOT EDIT!


#ifndef MOVEIT_MSGS_MESSAGE_MOVEGROUPACTION_H
#define MOVEIT_MSGS_MESSAGE_MOVEGROUPACTION_H
...
struct MoveGroupAction_
{
  typedef MoveGroupAction_<ContainerAllocator> Type;
  ...
  MoveGroupAction_(const ContainerAllocator& _alloc)
    : action_goal(_alloc)
  ...
  (void)_alloc;
   ...
   typedef  ::moveit_msgs::MoveGroupActionGoal_<ContainerAllocator>  _action_goal_type;
  _action_goal_type action_goal;

   typedef  ::moveit_msgs::MoveGroupActionResult_<ContainerAllocator>  _action_result_type;
  _action_result_type action_result;

   typedef  ::moveit_msgs::MoveGroupActionFeedback_<ContainerAllocator>  _action_feedback_type;
  ...
  typedef boost::shared_ptr< ::moveit_msgs::MoveGroupAction_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::moveit_msgs::MoveGroupAction_<ContainerAllocator> const> ConstPtr;

}; // struct MoveGroupAction_

typedef ::moveit_msgs::MoveGroupAction_<std::allocator<void> > MoveGroupAction;

typedef boost::shared_ptr< ::moveit_msgs::MoveGroupAction > MoveGroupActionPtr;
typedef boost::shared_ptr< ::moveit_msgs::MoveGroupAction const> MoveGroupActionConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::moveit_msgs::MoveGroupAction_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::moveit_msgs::MoveGroupAction_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::MoveGroupAction_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::MoveGroupAction_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::MoveGroupAction_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::MoveGroupAction_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::MoveGroupAction_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::MoveGroupAction_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::moveit_msgs::MoveGroupAction_<ContainerAllocator> >
{
  static const char* value()
  {
    return "be9c7984423000efe94194063f359cfc";
  }

  static const char* value(const ::moveit_msgs::MoveGroupAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xbe9c7984423000efULL;
  static const uint64_t static_value2 = 0xe94194063f359cfcULL;
};

template<class ContainerAllocator>
struct DataType< ::moveit_msgs::MoveGroupAction_<ContainerAllocator> >
{
  static const char* value()
  {
    return "moveit_msgs/MoveGroupAction";
  }
...
template<class ContainerAllocator>
struct Definition< ::moveit_msgs::MoveGroupAction_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::moveit_msgs::MoveGroupAction_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::moveit_msgs::MoveGroupAction_<ContainerAllocator> >
{
...
#endif // MOVEIT_MSGS_MESSAGE_MOVEGROUPACTION_H
