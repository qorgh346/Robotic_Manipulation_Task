// Generated by gencpp from file moveit_msgs/PositionIKRequest.msg
// DO NOT EDIT!


#ifndef MOVEIT_MSGS_MESSAGE_POSITIONIKREQUEST_H
#define MOVEIT_MSGS_MESSAGE_POSITIONIKREQUEST_H
...
struct PositionIKRequest_
{
  ...
  PositionIKRequest_(const ContainerAllocator& _alloc)
    ...
    , ik_link_name(_alloc)
    , pose_stamped(_alloc)
    , ik_link_names(_alloc)
    , pose_stamped_vector(_alloc)
    , timeout()
    , attempts(0)  {
  (void)_alloc;
    }
  ...
  _pose_stamped_type pose_stamped;
   ...
   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > , typename ContainerAllocator::template rebind<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::other >  _ik_link_names_type;
  _ik_link_names_type ik_link_names;

   typedef std::vector< ::geometry_msgs::PoseStamped_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::geometry_msgs::PoseStamped_<ContainerAllocator> >::other >  _pose_stamped_vector_type;
  ...
  typedef boost::shared_ptr< ::moveit_msgs::PositionIKRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::moveit_msgs::PositionIKRequest_<ContainerAllocator> const> ConstPtr;

}; // struct PositionIKRequest_

typedef ::moveit_msgs::PositionIKRequest_<std::allocator<void> > PositionIKRequest;

typedef boost::shared_ptr< ::moveit_msgs::PositionIKRequest > PositionIKRequestPtr;
typedef boost::shared_ptr< ::moveit_msgs::PositionIKRequest const> PositionIKRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::moveit_msgs::PositionIKRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::moveit_msgs::PositionIKRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::PositionIKRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::PositionIKRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::PositionIKRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::PositionIKRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::PositionIKRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::PositionIKRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::moveit_msgs::PositionIKRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::moveit_msgs::PositionIKRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x9936dc239c90af18ULL;
  static const uint64_t static_value2 = 0x0ec94a51596c96f2ULL;
};

template<class ContainerAllocator>
struct DataType< ::moveit_msgs::PositionIKRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::moveit_msgs::PositionIKRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::moveit_msgs::PositionIKRequest_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.ik_link_names);
      stream.next(m.pose_stamped_vector);
...
template<class ContainerAllocator>
struct Printer< ::moveit_msgs::PositionIKRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::moveit_msgs::PositionIKRequest_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.ik_link_names.size(); ++i)
    {
      ...
      Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.ik_link_names[i]);
    }
...
#endif // MOVEIT_MSGS_MESSAGE_POSITIONIKREQUEST_H
