// Generated by gencpp from file moveit_msgs/PlanningOptions.msg
// DO NOT EDIT!


#ifndef MOVEIT_MSGS_MESSAGE_PLANNINGOPTIONS_H
#define MOVEIT_MSGS_MESSAGE_PLANNINGOPTIONS_H
...
{
  typedef PlanningOptions_<ContainerAllocator> Type;
  ...
  PlanningOptions_(const ContainerAllocator& _alloc)
  ...
  (void)_alloc;
   ...
   typedef  ::moveit_msgs::PlanningScene_<ContainerAllocator>  _planning_scene_diff_type;
  _planning_scene_diff_type planning_scene_diff;

   typedef uint8_t _plan_only_type;
  _plan_only_type plan_only;

   typedef uint8_t _look_around_type;
  ...
  typedef boost::shared_ptr< ::moveit_msgs::PlanningOptions_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::moveit_msgs::PlanningOptions_<ContainerAllocator> const> ConstPtr;

}; // struct PlanningOptions_

typedef ::moveit_msgs::PlanningOptions_<std::allocator<void> > PlanningOptions;

typedef boost::shared_ptr< ::moveit_msgs::PlanningOptions > PlanningOptionsPtr;
typedef boost::shared_ptr< ::moveit_msgs::PlanningOptions const> PlanningOptionsConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::moveit_msgs::PlanningOptions_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::moveit_msgs::PlanningOptions_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::PlanningOptions_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::PlanningOptions_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::PlanningOptions_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::PlanningOptions_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::PlanningOptions_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::PlanningOptions_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::moveit_msgs::PlanningOptions_<ContainerAllocator> >
{
  ...
  static const char* value(const ::moveit_msgs::PlanningOptions_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3934e50ede2ecea0ULL;
  static const uint64_t static_value2 = 0x3e532aade900ab50ULL;
};

template<class ContainerAllocator>
struct DataType< ::moveit_msgs::PlanningOptions_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::moveit_msgs::PlanningOptions_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::moveit_msgs::PlanningOptions_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      stream.next(m.planning_scene_diff);
      stream.next(m.plan_only);
      stream.next(m.look_around);
      stream.next(m.look_around_attempts);
      stream.next(m.max_safe_execution_cost);
      stream.next(m.replan);
      stream.next(m.replan_attempts);
      stream.next(m.replan_delay);
    }
...
template<class ContainerAllocator>
struct Printer< ::moveit_msgs::PlanningOptions_<ContainerAllocator> >
{
...
#endif // MOVEIT_MSGS_MESSAGE_PLANNINGOPTIONS_H
