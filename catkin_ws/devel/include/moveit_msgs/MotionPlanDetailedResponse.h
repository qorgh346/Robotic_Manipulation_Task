// Generated by gencpp from file moveit_msgs/MotionPlanDetailedResponse.msg
// DO NOT EDIT!


#ifndef MOVEIT_MSGS_MESSAGE_MOTIONPLANDETAILEDRESPONSE_H
#define MOVEIT_MSGS_MESSAGE_MOTIONPLANDETAILEDRESPONSE_H
...
{
  typedef MotionPlanDetailedResponse_<ContainerAllocator> Type;

  MotionPlanDetailedResponse_()
    : trajectory_start()
    , group_name()
    , trajectory()
    , description()
  ...
  MotionPlanDetailedResponse_(const ContainerAllocator& _alloc)
  ...
  _description_type description;
   ...
   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _processing_time_type;
  ...
  typedef boost::shared_ptr< ::moveit_msgs::MotionPlanDetailedResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::moveit_msgs::MotionPlanDetailedResponse_<ContainerAllocator> const> ConstPtr;

}; // struct MotionPlanDetailedResponse_

typedef ::moveit_msgs::MotionPlanDetailedResponse_<std::allocator<void> > MotionPlanDetailedResponse;

typedef boost::shared_ptr< ::moveit_msgs::MotionPlanDetailedResponse > MotionPlanDetailedResponsePtr;
typedef boost::shared_ptr< ::moveit_msgs::MotionPlanDetailedResponse const> MotionPlanDetailedResponseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::moveit_msgs::MotionPlanDetailedResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::moveit_msgs::MotionPlanDetailedResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::MotionPlanDetailedResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::MotionPlanDetailedResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::MotionPlanDetailedResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::MotionPlanDetailedResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::MotionPlanDetailedResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::MotionPlanDetailedResponse_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::moveit_msgs::MotionPlanDetailedResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::moveit_msgs::MotionPlanDetailedResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x7b84c374bb2e37bdULL;
  static const uint64_t static_value2 = 0xc0eba664f7636a8fULL;
};

template<class ContainerAllocator>
struct DataType< ::moveit_msgs::MotionPlanDetailedResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::moveit_msgs::MotionPlanDetailedResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# The representation of a solution to a planning problem, including intermediate data\n\
\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::moveit_msgs::MotionPlanDetailedResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::moveit_msgs::MotionPlanDetailedResponse_<ContainerAllocator> >
{
...
#endif // MOVEIT_MSGS_MESSAGE_MOTIONPLANDETAILEDRESPONSE_H
