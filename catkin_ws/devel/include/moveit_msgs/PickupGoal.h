// Generated by gencpp from file moveit_msgs/PickupGoal.msg
// DO NOT EDIT!


#ifndef MOVEIT_MSGS_MESSAGE_PICKUPGOAL_H
#define MOVEIT_MSGS_MESSAGE_PICKUPGOAL_H
...
struct PickupGoal_
{
  ...
  PickupGoal_(const ContainerAllocator& _alloc)
    ...
    , group_name(_alloc)
    , end_effector(_alloc)
    , possible_grasps(_alloc)
    , support_surface_name(_alloc)
    , allow_gripper_support_collision(false)
    , attached_object_touch_links(_alloc)
    , minimize_object_distance(false)
  ...
  _end_effector_type end_effector;
   ...
   typedef std::vector< ::moveit_msgs::Grasp_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::moveit_msgs::Grasp_<ContainerAllocator> >::other >  _possible_grasps_type;
  ...
  _allow_gripper_support_collision_type allow_gripper_support_collision;
   ...
   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > , typename ContainerAllocator::template rebind<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::other >  _attached_object_touch_links_type;
  _attached_object_touch_links_type attached_object_touch_links;

   typedef uint8_t _minimize_object_distance_type;
  ...
  typedef boost::shared_ptr< ::moveit_msgs::PickupGoal_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::moveit_msgs::PickupGoal_<ContainerAllocator> const> ConstPtr;

}; // struct PickupGoal_

typedef ::moveit_msgs::PickupGoal_<std::allocator<void> > PickupGoal;

typedef boost::shared_ptr< ::moveit_msgs::PickupGoal > PickupGoalPtr;
typedef boost::shared_ptr< ::moveit_msgs::PickupGoal const> PickupGoalConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::moveit_msgs::PickupGoal_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::moveit_msgs::PickupGoal_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::PickupGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::PickupGoal_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::PickupGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::PickupGoal_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::PickupGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::PickupGoal_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::moveit_msgs::PickupGoal_<ContainerAllocator> >
{
  ...
  static const char* value(const ::moveit_msgs::PickupGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x458c6ab3761d73e9ULL;
  static const uint64_t static_value2 = 0x9b070063f7b74c2aULL;
};

template<class ContainerAllocator>
struct DataType< ::moveit_msgs::PickupGoal_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::moveit_msgs::PickupGoal_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::moveit_msgs::PickupGoal_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.possible_grasps);
      stream.next(m.support_surface_name);
      stream.next(m.allow_gripper_support_collision);
      stream.next(m.attached_object_touch_links);
      stream.next(m.minimize_object_distance);
...
template<class ContainerAllocator>
struct Printer< ::moveit_msgs::PickupGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::moveit_msgs::PickupGoal_<ContainerAllocator>& v)
  {
    ...
    s << indent << "possible_grasps[]" << std::endl;
    for (size_t i = 0; i < v.possible_grasps.size(); ++i)
    {
      s << indent << "  possible_grasps[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::moveit_msgs::Grasp_<ContainerAllocator> >::stream(s, indent + "    ", v.possible_grasps[i]);
    }
    ...
    s << indent << "attached_object_touch_links[]" << std::endl;
    for (size_t i = 0; i < v.attached_object_touch_links.size(); ++i)
    {
      s << indent << "  attached_object_touch_links[" << i << "]: ";
      Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.attached_object_touch_links[i]);
    }
    s << indent << "minimize_object_distance: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.minimize_object_distance);
...
#endif // MOVEIT_MSGS_MESSAGE_PICKUPGOAL_H
