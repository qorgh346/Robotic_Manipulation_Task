// Generated by gencpp from file moveit_msgs/MoveGroupResult.msg
// DO NOT EDIT!


#ifndef MOVEIT_MSGS_MESSAGE_MOVEGROUPRESULT_H
#define MOVEIT_MSGS_MESSAGE_MOVEGROUPRESULT_H
...
struct MoveGroupResult_
{
  typedef MoveGroupResult_<ContainerAllocator> Type;
  ...
  MoveGroupResult_(const ContainerAllocator& _alloc)
    : error_code(_alloc)
    , trajectory_start(_alloc)
    , planned_trajectory(_alloc)
    , executed_trajectory(_alloc)
    , planning_time(0.0)  {
  (void)_alloc;
    }
  ...
  _trajectory_start_type trajectory_start;
   ...
   typedef  ::moveit_msgs::RobotTrajectory_<ContainerAllocator>  _planned_trajectory_type;
  _planned_trajectory_type planned_trajectory;

   typedef  ::moveit_msgs::RobotTrajectory_<ContainerAllocator>  _executed_trajectory_type;
  ...
  typedef boost::shared_ptr< ::moveit_msgs::MoveGroupResult_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::moveit_msgs::MoveGroupResult_<ContainerAllocator> const> ConstPtr;

}; // struct MoveGroupResult_

typedef ::moveit_msgs::MoveGroupResult_<std::allocator<void> > MoveGroupResult;

typedef boost::shared_ptr< ::moveit_msgs::MoveGroupResult > MoveGroupResultPtr;
typedef boost::shared_ptr< ::moveit_msgs::MoveGroupResult const> MoveGroupResultConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::moveit_msgs::MoveGroupResult_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::moveit_msgs::MoveGroupResult_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::MoveGroupResult_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_msgs::MoveGroupResult_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::MoveGroupResult_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_msgs::MoveGroupResult_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::MoveGroupResult_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_msgs::MoveGroupResult_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::moveit_msgs::MoveGroupResult_<ContainerAllocator> >
{
  static const char* value()
  {
    return "34098589d402fee7ae9c3fd413e5a6c6";
  }

  static const char* value(const ::moveit_msgs::MoveGroupResult_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x34098589d402fee7ULL;
  static const uint64_t static_value2 = 0xae9c3fd413e5a6c6ULL;
};

template<class ContainerAllocator>
struct DataType< ::moveit_msgs::MoveGroupResult_<ContainerAllocator> >
{
  static const char* value()
  {
    return "moveit_msgs/MoveGroupResult";
  }
...
template<class ContainerAllocator>
struct Definition< ::moveit_msgs::MoveGroupResult_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::moveit_msgs::MoveGroupResult_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      stream.next(m.error_code);
      stream.next(m.trajectory_start);
      stream.next(m.planned_trajectory);
      stream.next(m.executed_trajectory);
...
template<class ContainerAllocator>
struct Printer< ::moveit_msgs::MoveGroupResult_<ContainerAllocator> >
{
...
#endif // MOVEIT_MSGS_MESSAGE_MOVEGROUPRESULT_H
