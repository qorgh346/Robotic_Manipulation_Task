// Generated by gencpp from file rosjava_custom_srv/PathServiceRequest.msg
// DO NOT EDIT!


#ifndef ROSJAVA_CUSTOM_SRV_MESSAGE_PATHSERVICEREQUEST_H
#define ROSJAVA_CUSTOM_SRV_MESSAGE_PATHSERVICEREQUEST_H
...
struct PathServiceRequest_
{
  ...
  _param1_type param1;
   ...
   typedef  ::rosjava_custom_srv::ActionGoalMsg_<ContainerAllocator>  _param2_type;
  _param2_type param2;
  ...
  typedef boost::shared_ptr< ::rosjava_custom_srv::PathServiceRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rosjava_custom_srv::PathServiceRequest_<ContainerAllocator> const> ConstPtr;

}; // struct PathServiceRequest_

typedef ::rosjava_custom_srv::PathServiceRequest_<std::allocator<void> > PathServiceRequest;

typedef boost::shared_ptr< ::rosjava_custom_srv::PathServiceRequest > PathServiceRequestPtr;
typedef boost::shared_ptr< ::rosjava_custom_srv::PathServiceRequest const> PathServiceRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rosjava_custom_srv::PathServiceRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rosjava_custom_srv::PathServiceRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::rosjava_custom_srv::PathServiceRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rosjava_custom_srv::PathServiceRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rosjava_custom_srv::PathServiceRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rosjava_custom_srv::PathServiceRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rosjava_custom_srv::PathServiceRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rosjava_custom_srv::PathServiceRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rosjava_custom_srv::PathServiceRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rosjava_custom_srv::PathServiceRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x274b9b2a768f1126ULL;
  static const uint64_t static_value2 = 0xa8aed88156fa0cb1ULL;
};

template<class ContainerAllocator>
struct DataType< ::rosjava_custom_srv::PathServiceRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::rosjava_custom_srv::PathServiceRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rosjava_custom_srv::PathServiceRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rosjava_custom_srv::PathServiceRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rosjava_custom_srv::PathServiceRequest_<ContainerAllocator>& v)
  {
    s << indent << "predicate: ";
    ...
    s << indent << "param2: ";
    s << std::endl;
    Printer< ::rosjava_custom_srv::ActionGoalMsg_<ContainerAllocator> >::stream(s, indent + "  ", v.param2);
...
#endif // ROSJAVA_CUSTOM_SRV_MESSAGE_PATHSERVICEREQUEST_H
