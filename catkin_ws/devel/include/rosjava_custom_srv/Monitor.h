// Generated by gencpp from file rosjava_custom_srv/Monitor.msg
// DO NOT EDIT!


#ifndef ROSJAVA_CUSTOM_SRV_MESSAGE_MONITOR_H
#define ROSJAVA_CUSTOM_SRV_MESSAGE_MONITOR_H
...
struct Monitor_
{
  ...
  typedef boost::shared_ptr< ::rosjava_custom_srv::Monitor_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rosjava_custom_srv::Monitor_<ContainerAllocator> const> ConstPtr;

}; // struct Monitor_

typedef ::rosjava_custom_srv::Monitor_<std::allocator<void> > Monitor;

typedef boost::shared_ptr< ::rosjava_custom_srv::Monitor > MonitorPtr;
typedef boost::shared_ptr< ::rosjava_custom_srv::Monitor const> MonitorConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rosjava_custom_srv::Monitor_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rosjava_custom_srv::Monitor_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::rosjava_custom_srv::Monitor_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rosjava_custom_srv::Monitor_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rosjava_custom_srv::Monitor_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rosjava_custom_srv::Monitor_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rosjava_custom_srv::Monitor_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rosjava_custom_srv::Monitor_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rosjava_custom_srv::Monitor_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rosjava_custom_srv::Monitor_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x9d1ca250acdc6ed9ULL;
  static const uint64_t static_value2 = 0xb2dc880631a21dcfULL;
};

template<class ContainerAllocator>
struct DataType< ::rosjava_custom_srv::Monitor_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::rosjava_custom_srv::Monitor_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rosjava_custom_srv::Monitor_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rosjava_custom_srv::Monitor_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rosjava_custom_srv::Monitor_<ContainerAllocator>& v)
  {
    s << indent << "predicate: ";
...
#endif // ROSJAVA_CUSTOM_SRV_MESSAGE_MONITOR_H
