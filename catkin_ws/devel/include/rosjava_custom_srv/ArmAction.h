// Generated by gencpp from file rosjava_custom_srv/ArmAction.msg
// DO NOT EDIT!


#ifndef ROSJAVA_CUSTOM_SRV_MESSAGE_ARMACTION_H
#define ROSJAVA_CUSTOM_SRV_MESSAGE_ARMACTION_H
...
struct ArmAction_
{
  ...
  _targetBody_type targetBody;
   ...
   typedef int32_t _actionGoal_type;
  _actionGoal_type actionGoal;
  ...
  typedef boost::shared_ptr< ::rosjava_custom_srv::ArmAction_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rosjava_custom_srv::ArmAction_<ContainerAllocator> const> ConstPtr;

}; // struct ArmAction_

typedef ::rosjava_custom_srv::ArmAction_<std::allocator<void> > ArmAction;

typedef boost::shared_ptr< ::rosjava_custom_srv::ArmAction > ArmActionPtr;
typedef boost::shared_ptr< ::rosjava_custom_srv::ArmAction const> ArmActionConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rosjava_custom_srv::ArmAction_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rosjava_custom_srv::ArmAction_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::rosjava_custom_srv::ArmAction_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rosjava_custom_srv::ArmAction_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rosjava_custom_srv::ArmAction_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rosjava_custom_srv::ArmAction_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rosjava_custom_srv::ArmAction_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rosjava_custom_srv::ArmAction_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rosjava_custom_srv::ArmAction_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rosjava_custom_srv::ArmAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd323d58b7cd12eadULL;
  static const uint64_t static_value2 = 0xc4032416c7d28382ULL;
};

template<class ContainerAllocator>
struct DataType< ::rosjava_custom_srv::ArmAction_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::rosjava_custom_srv::ArmAction_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rosjava_custom_srv::ArmAction_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      stream.next(m.targetBody);
      stream.next(m.actionGoal);
...
template<class ContainerAllocator>
struct Printer< ::rosjava_custom_srv::ArmAction_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rosjava_custom_srv::ArmAction_<ContainerAllocator>& v)
  {
    s << indent << "targetBody: ";
    Printer<int32_t>::stream(s, indent + "  ", v.targetBody);
    s << indent << "actionGoal: ";
    Printer<int32_t>::stream(s, indent + "  ", v.actionGoal);
    s << indent << "object: ";
...
#endif // ROSJAVA_CUSTOM_SRV_MESSAGE_ARMACTION_H
