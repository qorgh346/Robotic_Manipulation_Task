// Generated by gencpp from file rosjava_custom_srv/ActionGoalMsg.msg
// DO NOT EDIT!


#ifndef ROSJAVA_CUSTOM_SRV_MESSAGE_ACTIONGOALMSG_H
#define ROSJAVA_CUSTOM_SRV_MESSAGE_ACTIONGOALMSG_H
...
struct ActionGoalMsg_
{
  typedef ActionGoalMsg_<ContainerAllocator> Type;
  ...
  ActionGoalMsg_(const ContainerAllocator& _alloc)
    : targetBody(0)
    , actionType(0)
    , object(_alloc)
    ...
    , targetPose(_alloc)
    , targetJointState(_alloc)  {
  (void)_alloc;
    }



   typedef int32_t _targetBody_type;
  _targetBody_type targetBody;
  ...
  _targetPose_type targetPose;
   ...
   typedef  ::sensor_msgs::JointState_<ContainerAllocator>  _targetJointState_type;
  _targetJointState_type targetJointState;





  typedef boost::shared_ptr< ::rosjava_custom_srv::ActionGoalMsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rosjava_custom_srv::ActionGoalMsg_<ContainerAllocator> const> ConstPtr;

}; // struct ActionGoalMsg_

typedef ::rosjava_custom_srv::ActionGoalMsg_<std::allocator<void> > ActionGoalMsg;

typedef boost::shared_ptr< ::rosjava_custom_srv::ActionGoalMsg > ActionGoalMsgPtr;
typedef boost::shared_ptr< ::rosjava_custom_srv::ActionGoalMsg const> ActionGoalMsgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rosjava_custom_srv::ActionGoalMsg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rosjava_custom_srv::ActionGoalMsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::rosjava_custom_srv::ActionGoalMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rosjava_custom_srv::ActionGoalMsg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rosjava_custom_srv::ActionGoalMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rosjava_custom_srv::ActionGoalMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rosjava_custom_srv::ActionGoalMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rosjava_custom_srv::ActionGoalMsg_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rosjava_custom_srv::ActionGoalMsg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rosjava_custom_srv::ActionGoalMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x31a8a01349e4a804ULL;
  static const uint64_t static_value2 = 0x908a768499ac37dfULL;
};

template<class ContainerAllocator>
struct DataType< ::rosjava_custom_srv::ActionGoalMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::rosjava_custom_srv::ActionGoalMsg_<ContainerAllocator> >
{
  static const char* value()
  {
    return "int32 targetBody\n\
int32 actionType\n\
string object\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rosjava_custom_srv::ActionGoalMsg_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      stream.next(m.targetBody);
      ...
      stream.next(m.targetJointState);
    }
...
template<class ContainerAllocator>
struct Printer< ::rosjava_custom_srv::ActionGoalMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rosjava_custom_srv::ActionGoalMsg_<ContainerAllocator>& v)
  {
    s << indent << "targetBody: ";
    Printer<int32_t>::stream(s, indent + "  ", v.targetBody);
    s << indent << "actionType: ";
    ...
    s << indent << "targetJointState: ";
    s << std::endl;
    Printer< ::sensor_msgs::JointState_<ContainerAllocator> >::stream(s, indent + "  ", v.targetJointState);
  }
};
...
#endif // ROSJAVA_CUSTOM_SRV_MESSAGE_ACTIONGOALMSG_H
