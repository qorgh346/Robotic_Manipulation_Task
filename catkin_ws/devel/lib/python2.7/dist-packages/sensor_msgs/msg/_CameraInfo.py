...
"""autogenerated by genpy from sensor_msgs/CameraInfo.msg. Do not edit."""
import codecs
import sys
...
class CameraInfo(genpy.Message):
  ...
  _full_text = """# This message defines meta information for a camera. It should be in a
...
"""
  ...
  _slot_types = ['std_msgs/Header','uint32','uint32','string','float64[]','float64[9]','float64[9]','float64[12]','uint32','uint32','sensor_msgs/RegionOfInterest']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_9d().pack(*self.K))
      buff.write(_get_struct_9d().pack(*self.R))
      buff.write(_get_struct_12d().pack(*self.P))
      _x = self
      buff.write(_get_struct_6IB().pack(_x.binning_x, _x.binning_y, _x.roi.x_offset, _x.roi.y_offset, _x.roi.height, _x.roi.width, _x.roi.do_rectify))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.distortion_model = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.distortion_model = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.K = _get_struct_9d().unpack(str[start:end])
      start = end
      end += 72
      self.R = _get_struct_9d().unpack(str[start:end])
      start = end
      end += 96
      self.P = _get_struct_12d().unpack(str[start:end])
      _x = self
      start = end
      end += 25
      (_x.binning_x, _x.binning_y, _x.roi.x_offset, _x.roi.y_offset, _x.roi.height, _x.roi.width, _x.roi.do_rectify,) = _get_struct_6IB().unpack(str[start:end])
