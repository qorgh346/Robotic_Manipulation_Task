...
"""autogenerated by genpy from sensor_msgs/RelativeHumidity.msg. Do not edit."""
import codecs
import sys
...
class RelativeHumidity(genpy.Message):
  ...
  _full_text = """ # Single reading from a relative humidity sensor.  Defines the ratio of partial
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2d().pack(_x.relative_humidity, _x.variance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.relative_humidity, _x.variance,) = _get_struct_2d().unpack(str[start:end])
      return self
