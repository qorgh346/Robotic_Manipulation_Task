...
"""autogenerated by genpy from sensor_msgs/Temperature.msg. Do not edit."""
import codecs
import sys
...
class Temperature(genpy.Message):
  ...
  _full_text = """ # Single temperature reading.
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2d().pack(_x.temperature, _x.variance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.temperature, _x.variance,) = _get_struct_2d().unpack(str[start:end])
      return self
