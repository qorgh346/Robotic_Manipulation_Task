...
"""autogenerated by genpy from sensor_msgs/TimeReference.msg. Do not edit."""
import codecs
import sys
...
class TimeReference(genpy.Message):
  ...
  _full_text = """# Measurement from an external time source not actively synchronized with the system clock.
...
"""
  ...
  _slot_types = ['std_msgs/Header','time','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TimeReference, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2I().pack(_x.time_ref.secs, _x.time_ref.nsecs))
      _x = self.source
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
