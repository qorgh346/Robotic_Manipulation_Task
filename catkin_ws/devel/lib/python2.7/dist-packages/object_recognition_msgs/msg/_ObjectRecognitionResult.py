...
"""autogenerated by genpy from object_recognition_msgs/ObjectRecognitionResult.msg. Do not edit."""
import codecs
import sys
...
class ObjectRecognitionResult(genpy.Message):
  _md5sum = "868e41288f9f8636e2b6c51f1af6aa9c"
  _type = "object_recognition_msgs/ObjectRecognitionResult"
...
float64 w
"""
  __slots__ = ['recognized_objects']
  _slot_types = ['object_recognition_msgs/RecognizedObjectArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ObjectRecognitionResult, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.recognized_objects is None:
        self.recognized_objects = object_recognition_msgs.msg.RecognizedObjectArray()
    else:
      self.recognized_objects = object_recognition_msgs.msg.RecognizedObjectArray()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3I().pack(_x.recognized_objects.header.seq, _x.recognized_objects.header.stamp.secs, _x.recognized_objects.header.stamp.nsecs))
      ...
      length = len(self.recognized_objects.cooccurrence)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.recognized_objects.cooccurrence))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.recognized_objects.header.seq, _x.recognized_objects.header.stamp.secs, _x.recognized_objects.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      ...
      if python3:
        self.recognized_objects.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.recognized_objects.cooccurrence = s.unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.recognized_objects.cooccurrence.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.recognized_objects.cooccurrence = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
