...
"""autogenerated by genpy from object_recognition_msgs/ObjectRecognitionAction.msg. Do not edit."""
import codecs
import sys
...
class ObjectRecognitionAction(genpy.Message):
  _md5sum = "7d8979a0cf97e5078553ee3efee047d2"
  _type = "object_recognition_msgs/ObjectRecognitionAction"
...
"""
  ...
  _slot_types = ['object_recognition_msgs/ObjectRecognitionActionGoal','object_recognition_msgs/ObjectRecognitionActionResult','object_recognition_msgs/ObjectRecognitionActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ObjectRecognitionAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = object_recognition_msgs.msg.ObjectRecognitionActionGoal()
      if self.action_result is None:
        self.action_result = object_recognition_msgs.msg.ObjectRecognitionActionResult()
      if self.action_feedback is None:
        self.action_feedback = object_recognition_msgs.msg.ObjectRecognitionActionFeedback()
    else:
      self.action_goal = object_recognition_msgs.msg.ObjectRecognitionActionGoal()
      self.action_result = object_recognition_msgs.msg.ObjectRecognitionActionResult()
      self.action_feedback = object_recognition_msgs.msg.ObjectRecognitionActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.use_roi
      buff.write(_get_struct_B().pack(_x))
      length = len(self.action_goal.goal.filter_limits)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.filter_limits))
      _x = self
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_result.result.recognized_objects.header.seq, _x.action_result.result.recognized_objects.header.stamp.secs, _x.action_result.result.recognized_objects.header.stamp.nsecs))
      _x = self.action_result.result.recognized_objects.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.action_result.result.recognized_objects.objects)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.recognized_objects.objects:
        _v1 = val1.header
        _x = _v1.seq
      ...
      length = len(self.action_result.result.recognized_objects.cooccurrence)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.action_result.result.recognized_objects.cooccurrence))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_goal.goal.use_roi,) = _get_struct_B().unpack(str[start:end])
      self.action_goal.goal.use_roi = bool(self.action_goal.goal.use_roi)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.action_goal.goal.filter_limits = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
      ...
      (_x.action_result.result.recognized_objects.header.seq, _x.action_result.result.recognized_objects.header.stamp.secs, _x.action_result.result.recognized_objects.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.recognized_objects.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_result.result.recognized_objects.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.recognized_objects.objects = []
      for i in range(0, length):
        ...
        self.action_result.result.recognized_objects.objects.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.action_result.result.recognized_objects.cooccurrence = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.action_goal.goal.filter_limits.tostring())
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      _x = self.action_result.header.frame_id
      length = len(_x)
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.action_result.result.recognized_objects.cooccurrence.tostring())
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      _x = self.action_feedback.header.frame_id
      length = len(_x)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_goal.goal.filter_limits = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      _x = self
      start = end
      end += 12
      (_x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      ...
      self.action_result.result.recognized_objects.cooccurrence = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      _x = self
      start = end
      end += 12
      (_x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
