...
"""autogenerated by genpy from object_recognition_msgs/RecognizedObjectArray.msg. Do not edit."""
import codecs
import sys
...
class RecognizedObjectArray(genpy.Message):
  _md5sum = "bad6b1546b9ebcabb49fb3b858d78964"
  _type = "object_recognition_msgs/RecognizedObjectArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','object_recognition_msgs/RecognizedObject[]','float32[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.cooccurrence))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.cooccurrence = s.unpack(str[start:end])
      return self
