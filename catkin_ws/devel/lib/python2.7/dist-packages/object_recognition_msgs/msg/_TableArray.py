...
"""autogenerated by genpy from object_recognition_msgs/TableArray.msg. Do not edit."""
import codecs
import sys
...
class TableArray(genpy.Message):
  _md5sum = "d1c853e5acd0ed273eb6682dc01ab428"
  _type = "object_recognition_msgs/TableArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','object_recognition_msgs/Table[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TableArray, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = object_recognition_msgs.msg.Table()
        _v6 = val1.header
        start = end
        end += 4
