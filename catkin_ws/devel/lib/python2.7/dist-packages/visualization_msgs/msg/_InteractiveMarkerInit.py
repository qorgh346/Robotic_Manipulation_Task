...
"""
      ...
      for val1 in self.markers:
        ...
        for val2 in val1.controls:
          ...
          for val3 in val2.markers:
            ...
            buff.write(_get_struct_B().pack(_x))
          _x = val2.independent_marker_orientation
          buff.write(_get_struct_B().pack(_x))
          _x = val2.description
          length = len(_x)
          if python3 or type(_x) == unicode:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.server_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            val2.title = str[start:end].decode('utf-8', 'rosmsg')
          else:
