      ...
      for val1 in self.controls:
        ...
        for val2 in val1.markers:
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
          _x = val2.mesh_use_embedded_materials
          buff.write(_get_struct_B().pack(_x))
        _x = val1.independent_marker_orientation
        buff.write(_get_struct_B().pack(_x))
        _x = val1.description
        length = len(_x)
        if python3 or type(_x) == unicode:
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            val2.ns = str[start:end].decode('utf-8', 'rosmsg')
          else:
          ...
          if python3:
            val2.mesh_resource = str[start:end].decode('utf-8', 'rosmsg')
          else:
