...
"""autogenerated by genpy from rosjava_custom_srv/Monitor.msg. Do not edit."""
import codecs
import sys
...
class Monitor(genpy.Message):
  _md5sum = "9d1ca250acdc6ed9b2dc880631a21dcf"
  _type = "rosjava_custom_srv/Monitor"
...
int32 status"""
  __slots__ = ['predicate','param1','param2','param3','param4','status']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       predicate,param1,param2,param3,param4,status
