...
"""autogenerated by genpy from rosjava_custom_srv/ArmAction.msg. Do not edit."""
import codecs
import sys
...
class ArmAction(genpy.Message):
  _md5sum = "d323d58b7cd12eadc4032416c7d28382"
  _type = "rosjava_custom_srv/ArmAction"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """int32 targetBody
int32 actionGoal
string object
...
float64[] effort
"""
  __slots__ = ['targetBody','actionGoal','object','joint_constraints','position_constraints','orientation_constraints','visibility_constraints','targetPose','targetJointState']
  _slot_types = ['int32','int32','string','moveit_msgs/JointConstraint[]','moveit_msgs/PositionConstraint[]','moveit_msgs/OrientationConstraint[]','moveit_msgs/VisibilityConstraint[]','geometry_msgs/PoseStamped','sensor_msgs/JointState']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       targetBody,actionGoal,object,joint_constraints,position_constraints,orientation_constraints,visibility_constraints,targetPose,targetJointState
    ...
    if args or kwds:
      ...
      if self.targetBody is None:
        self.targetBody = 0
      if self.actionGoal is None:
        self.actionGoal = 0
      ...
      if self.targetJointState is None:
        self.targetJointState = sensor_msgs.msg.JointState()
    else:
      self.targetBody = 0
      self.actionGoal = 0
      self.object = ''
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2i().pack(_x.targetBody, _x.actionGoal))
      _x = self.object
      length = len(_x)
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7d3I().pack(_x.targetPose.pose.position.x, _x.targetPose.pose.position.y, _x.targetPose.pose.position.z, _x.targetPose.pose.orientation.x, _x.targetPose.pose.orientation.y, _x.targetPose.pose.orientation.z, _x.targetPose.pose.orientation.w, _x.targetJointState.header.seq, _x.targetJointState.header.stamp.secs, _x.targetJointState.header.stamp.nsecs))
      _x = self.targetJointState.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.targetJointState.name)
      buff.write(_struct_I.pack(length))
      for val1 in self.targetJointState.name:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      length = len(self.targetJointState.position)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.targetJointState.position))
      length = len(self.targetJointState.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.targetJointState.velocity))
      length = len(self.targetJointState.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.targetJointState.effort))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.targetBody, _x.actionGoal,) = _get_struct_2i().unpack(str[start:end])
      start = end
      end += 4
      ...
      if python3:
        self.targetJointState.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.targetJointState.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.targetJointState.name = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.targetJointState.name.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.targetJointState.position = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.targetJointState.velocity = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.targetJointState.effort = s.unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.targetJointState.position.tostring())
      length = len(self.targetJointState.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.targetJointState.velocity.tostring())
      length = len(self.targetJointState.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.targetJointState.effort.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.targetJointState.position = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.targetJointState.velocity = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.targetJointState.effort = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
