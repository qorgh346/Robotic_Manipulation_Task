...
"""autogenerated by genpy from nav_msgs/GetMapAction.msg. Do not edit."""
import codecs
import sys
...
class GetMapAction(genpy.Message):
  _md5sum = "e611ad23fbf237c031b7536416dc7cd7"
  _type = "nav_msgs/GetMapAction"
...
"""
  ...
  _slot_types = ['nav_msgs/GetMapActionGoal','nav_msgs/GetMapActionResult','nav_msgs/GetMapActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetMapAction, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sb'%length
      buff.write(struct.Struct(pattern).pack(*self.action_result.result.map.data))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_result.result.map.data = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
