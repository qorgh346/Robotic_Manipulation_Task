  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v55.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v55.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v145.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v145.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v215.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v218.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v218.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v215.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v272.seq,) = _get_struct_I().unpack(str[start:end])
        _v273 = _v272.stamp
        _x = _v273
        start = end
        end += 8
        ...
        if python3:
          _v272.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v271.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v274.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v274.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v271.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
