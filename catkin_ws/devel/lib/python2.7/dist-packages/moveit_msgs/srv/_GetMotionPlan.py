...
class GetMotionPlanRequest(genpy.Message):
  _md5sum = "9dcb82c5daeb2ff8a7ab1a98b642871d"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.motion_plan_request.start_state.joint_state.position))
      length = len(self.motion_plan_request.start_state.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.motion_plan_request.start_state.joint_state.velocity))
      length = len(self.motion_plan_request.start_state.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.motion_plan_request.start_state.joint_state.effort))
      _x = self
      ...
      _x = self.motion_plan_request.start_state.is_diff
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.motion_plan_request.workspace_parameters.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.motion_plan_request.start_state.joint_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.motion_plan_request.start_state.joint_state.position = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.motion_plan_request.start_state.joint_state.velocity = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.motion_plan_request.start_state.joint_state.effort = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.motion_plan_request.start_state.multi_dof_joint_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v96.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v99.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v99.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v96.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      if python3:
        self.motion_plan_request.path_constraints.name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.motion_plan_request.planner_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.motion_plan_request.group_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v274.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v277.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v277.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v274.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          (_v288.seq,) = _get_struct_I().unpack(str[start:end])
          _v289 = _v288.stamp
          _x = _v289
          start = end
          end += 8
          ...
          if python3:
            _v288.frame_id = str[start:end].decode('utf-8', 'rosmsg')
          else:
        ...
        for i in range(0, length):
          ...
          if python3:
            _v300.frame_id = str[start:end].decode('utf-8', 'rosmsg')
          else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v311.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
      ...
      for i in range(0, length):
        ...
        (_v319.seq,) = _get_struct_I().unpack(str[start:end])
        _v320 = _v319.stamp
        _x = _v320
        start = end
        end += 8
        ...
        if python3:
          _v319.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
...
class GetMotionPlanResponse(genpy.Message):
  _md5sum = "37fe7e8f0d4dfa55ccfa53d63c86ae15"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.motion_plan_response.trajectory_start.joint_state.position))
      length = len(self.motion_plan_response.trajectory_start.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.motion_plan_response.trajectory_start.joint_state.velocity))
      length = len(self.motion_plan_response.trajectory_start.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.motion_plan_response.trajectory_start.joint_state.effort))
      _x = self
      ...
      for val1 in self.motion_plan_response.trajectory_start.attached_collision_objects:
        ...
        buff.write(_struct_I.pack(length))
        for val3 in _v363.primitive_poses:
          _v367 = val3.position
          _x = _v367
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        ...
        for val3 in _v363.mesh_poses:
          ...
          _x = _v370
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v363.planes)
        buff.write(_struct_I.pack(length))
        for val3 in _v363.planes:
          buff.write(_get_struct_4d().pack(*val3.coef))
        length = len(_v363.plane_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v363.plane_poses:
          _v371 = val3.position
          _x = _v371
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v372 = val3.orientation
          _x = _v372
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        _x = _v363.operation
        buff.write(_get_struct_b().pack(_x))
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v373.joint_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v373.joint_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v373.points)
        buff.write(_struct_I.pack(length))
        for val3 in _v373.points:
          length = len(val3.positions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(struct.Struct(pattern).pack(*val3.positions))
          ...
          pattern = '<%sd'%length
          buff.write(struct.Struct(pattern).pack(*val3.effort))
          _v376 = val3.time_from_start
          _x = _v376
          buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
        _x = val1.weight
        buff.write(_get_struct_d().pack(_x))
      _x = self.motion_plan_response.trajectory_start.is_diff
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.motion_plan_response.trajectory_start.joint_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.motion_plan_response.trajectory_start.joint_state.position = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.motion_plan_response.trajectory_start.joint_state.velocity = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.motion_plan_response.trajectory_start.joint_state.effort = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.motion_plan_response.trajectory_start.multi_dof_joint_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v391.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v391.id = str[start:end]
        _v394 = _v391.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          _v394.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v394.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v394.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v394.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v391.primitives = []
        for i in range(0, length):
          ...
          val3.dimensions = s.unpack(str[start:end])
          _v391.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v391.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v395 = val3.position
          _x = _v395
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v391.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v391.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v391.plane_poses.append(val3)
        start = end
        end += 1
        (_v391.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
        ...
        for i in range(0, length):
          ...
          val3.effort = s.unpack(str[start:end])
          _v404 = val3.time_from_start
          _x = _v404
          start = end
          end += 8
          (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
          _v401.points.append(val3)
        start = end
        end += 8
        (val1.weight,) = _get_struct_d().unpack(str[start:end])
      ...
      if python3:
        self.motion_plan_response.group_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.motion_plan_response.trajectory.joint_trajectory.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.motion_plan_response.trajectory.multi_dof_joint_trajectory.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
    ...
    try:
      ...
      for val1 in self.motion_plan_response.trajectory_start.attached_collision_objects:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v419.primitives)
        buff.write(_struct_I.pack(length))
        for val3 in _v419.primitives:
          _x = val3.type
          buff.write(_get_struct_B().pack(_x))
          length = len(val3.dimensions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(val3.dimensions.tostring())
        length = len(_v419.primitive_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v419.primitive_poses:
          _v423 = val3.position
          _x = _v423
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v424 = val3.orientation
          _x = _v424
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v419.meshes)
        buff.write(_struct_I.pack(length))
        for val3 in _v419.meshes:
          length = len(val3.triangles)
          buff.write(_struct_I.pack(length))
          for val4 in val3.triangles:
            buff.write(val4.vertex_indices.tostring())
          ...
          for val4 in val3.vertices:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v419.mesh_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v419.mesh_poses:
          _v425 = val3.position
          _x = _v425
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v426 = val3.orientation
          _x = _v426
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v419.planes)
        buff.write(_struct_I.pack(length))
        for val3 in _v419.planes:
          buff.write(val3.coef.tostring())
        length = len(_v419.plane_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v419.plane_poses:
          _v427 = val3.position
          _x = _v427
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v429.joint_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v429.joint_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v429.points)
        buff.write(_struct_I.pack(length))
        for val3 in _v429.points:
          length = len(val3.positions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(val3.positions.tostring())
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v447.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v447.id = str[start:end]
        _v450 = _v447.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v447.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v447.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v447.plane_poses.append(val3)
        start = end
        end += 1
        (_v447.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
        ...
        for i in range(0, length):
          ...
          val3.effort = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
          _v460 = val3.time_from_start
          _x = _v460
          start = end
          end += 8
          (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
          _v457.points.append(val3)
        start = end
        end += 8
        (val1.weight,) = _get_struct_d().unpack(str[start:end])
        self.motion_plan_response.trajectory_start.attached_collision_objects.append(val1)
...
class GetMotionPlan(object):
  ...
  _md5sum = '657e571ceabcb225c850c02c2249a1e1'
