...
class GetPositionIKRequest(genpy.Message):
  _md5sum = "a67dc7e99d15c1dca32a77c22bc2d93b"
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1.link_name = str[start:end]
        _v71 = val1.target_point_offset
        _x = _v71
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v72 = val1.constraint_region
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v72.primitives = []
        for i in range(0, length):
          ...
          val3.dimensions = s.unpack(str[start:end])
          _v72.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v72.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v73 = val3.position
          _x = _v73
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v72.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v72.meshes = []
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.ik_request.constraints.position_constraints:
        ...
        length = len(_v120.primitives)
        buff.write(_struct_I.pack(length))
        for val3 in _v120.primitives:
          _x = val3.type
          buff.write(_get_struct_B().pack(_x))
          length = len(val3.dimensions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(val3.dimensions.tostring())
        length = len(_v120.primitive_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v120.primitive_poses:
          _v121 = val3.position
          _x = _v121
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v122
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v120.meshes)
        buff.write(_struct_I.pack(length))
        for val3 in _v120.meshes:
          length = len(val3.triangles)
          buff.write(_struct_I.pack(length))
          for val4 in val3.triangles:
            buff.write(val4.vertex_indices.tostring())
          ...
          for val4 in val3.vertices:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v120.mesh_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v120.mesh_poses:
          _v123 = val3.position
          _x = _v123
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1.link_name = str[start:end]
        _v167 = val1.target_point_offset
        _x = _v167
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v168 = val1.constraint_region
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v168.primitives = []
        for i in range(0, length):
          ...
          val3.dimensions = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
          _v168.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v168.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v169 = val3.position
          _x = _v169
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v168.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v168.meshes = []
    ...
    try:
      ...
      for val1 in self.solution.attached_collision_objects:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v199.primitives)
        buff.write(_struct_I.pack(length))
        for val3 in _v199.primitives:
          _x = val3.type
          buff.write(_get_struct_B().pack(_x))
          length = len(val3.dimensions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(struct.Struct(pattern).pack(*val3.dimensions))
        length = len(_v199.primitive_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v199.primitive_poses:
          _v203 = val3.position
          _x = _v203
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v204
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v199.meshes)
        buff.write(_struct_I.pack(length))
        for val3 in _v199.meshes:
          length = len(val3.triangles)
          buff.write(_struct_I.pack(length))
          for val4 in val3.triangles:
            buff.write(_get_struct_3I().pack(*val4.vertex_indices))
          ...
          for val4 in val3.vertices:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v199.mesh_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v199.mesh_poses:
          _v205 = val3.position
          _x = _v205
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v206
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v199.planes)
        buff.write(_struct_I.pack(length))
        for val3 in _v199.planes:
          buff.write(_get_struct_4d().pack(*val3.coef))
        length = len(_v199.plane_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v199.plane_poses:
          _v207 = val3.position
          _x = _v207
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v219.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v219.id = str[start:end]
        _v222 = _v219.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          _v222.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v222.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v222.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v222.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v219.primitives = []
        for i in range(0, length):
          ...
          val3.dimensions = s.unpack(str[start:end])
          _v219.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v219.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v223 = val3.position
          _x = _v223
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v219.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v219.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v228 = val3.orientation
          _x = _v228
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v219.plane_poses.append(val3)
        start = end
        end += 1
        (_v219.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
        ...
        if python3:
          _v230.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        for i in range(0, length):
          ...
          val3.effort = s.unpack(str[start:end])
          _v232 = val3.time_from_start
          _x = _v232
          start = end
          end += 8
          (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
          _v229.points.append(val3)
        start = end
        end += 8
        (val1.weight,) = _get_struct_d().unpack(str[start:end])
    ...
    try:
      ...
      for val1 in self.solution.attached_collision_objects:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v239.primitives)
        buff.write(_struct_I.pack(length))
        for val3 in _v239.primitives:
          _x = val3.type
          buff.write(_get_struct_B().pack(_x))
          length = len(val3.dimensions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(val3.dimensions.tostring())
        length = len(_v239.primitive_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v239.primitive_poses:
          _v243 = val3.position
          _x = _v243
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v244
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v239.meshes)
        buff.write(_struct_I.pack(length))
        for val3 in _v239.meshes:
          length = len(val3.triangles)
          buff.write(_struct_I.pack(length))
          for val4 in val3.triangles:
            buff.write(val4.vertex_indices.tostring())
          ...
          for val4 in val3.vertices:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v239.mesh_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v239.mesh_poses:
          _v245 = val3.position
          _x = _v245
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v246
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v239.planes)
        buff.write(_struct_I.pack(length))
        for val3 in _v239.planes:
          buff.write(val3.coef.tostring())
        length = len(_v239.plane_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v239.plane_poses:
          _v247 = val3.position
          _x = _v247
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v249.joint_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v249.joint_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v249.points)
        buff.write(_struct_I.pack(length))
        for val3 in _v249.points:
          length = len(val3.positions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(val3.positions.tostring())
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v262.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v262.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v262.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v262.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v259.primitives = []
        ...
        for i in range(0, length):
          ...
          val3.effort = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
          _v272 = val3.time_from_start
          _x = _v272
          start = end
          end += 8
          (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
          _v269.points.append(val3)
        start = end
        end += 8
        (val1.weight,) = _get_struct_d().unpack(str[start:end])
        self.solution.attached_collision_objects.append(val1)
...
class GetPositionIK(object):
  ...
  _md5sum = '0661ea3324398c69f5a971d0ec55657e'
