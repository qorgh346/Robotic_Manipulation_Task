  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v50.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v50.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v136.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v139.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v139.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v136.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
