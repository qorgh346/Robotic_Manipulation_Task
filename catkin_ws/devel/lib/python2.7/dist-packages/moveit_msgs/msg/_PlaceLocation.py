...
class PlaceLocation(genpy.Message):
  _md5sum = "f3dbcaca40fb29ede2af78b3e1831128"
...
float64 y
float64 z"""
  __slots__ = ['id','post_place_posture','place_pose','pre_place_approach','post_place_retreat','allowed_touch_objects']
  _slot_types = ['string','trajectory_msgs/JointTrajectory','geometry_msgs/PoseStamped','moveit_msgs/GripperTranslation','moveit_msgs/GripperTranslation','string[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,post_place_posture,place_pose,pre_place_approach,post_place_retreat,allowed_touch_objects
