...
class TrajectoryConstraints(genpy.Message):
  _md5sum = "461e1a732dfebb01e7d6c75d51a51eac"
  _type = "moveit_msgs/TrajectoryConstraints"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# The array of constraints to consider along the trajectory
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          for i in range(0, length):
            ...
            _v27.primitive_poses.append(val4)
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v27.meshes = []
      ...
      for val1 in self.constraints:
        ...
        for val2 in val1.position_constraints:
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
          _v49 = val2.target_point_offset
          _x = _v49
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v50 = val2.constraint_region
          length = len(_v50.primitives)
          buff.write(_struct_I.pack(length))
          for val4 in _v50.primitives:
            _x = val4.type
            buff.write(_get_struct_B().pack(_x))
            length = len(val4.dimensions)
            buff.write(_struct_I.pack(length))
          ...
          buff.write(_struct_I.pack(length))
          for val4 in _v50.primitive_poses:
            _v51 = val4.position
            _x = _v51
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            ...
            val2.link_name = str[start:end]
          _v72 = val2.target_point_offset
          _x = _v72
          start = end
          end += 24
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v73 = val2.constraint_region
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v73.primitives = []
          ...
          for i in range(0, length):
            ...
            (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
            _v75 = val4.orientation
            _x = _v75
            start = end
            end += 32
            (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
            _v73.primitive_poses.append(val4)
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v73.meshes = []
