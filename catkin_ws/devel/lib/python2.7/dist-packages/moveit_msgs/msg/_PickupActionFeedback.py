...
"""autogenerated by genpy from moveit_msgs/PickupActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class PickupActionFeedback(genpy.Message):
  _md5sum = "12232ef97486c7962f264c105aae2958"
  _type = "moveit_msgs/PickupActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','moveit_msgs/PickupFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PickupActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = moveit_msgs.msg.PickupFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = moveit_msgs.msg.PickupFeedback()
