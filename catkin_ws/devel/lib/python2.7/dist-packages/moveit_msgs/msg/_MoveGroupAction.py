...
class MoveGroupAction(genpy.Message):
  _md5sum = "be9c7984423000efe94194063f359cfc"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.request.start_state.joint_state.position))
      length = len(self.action_goal.goal.request.start_state.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.request.start_state.joint_state.velocity))
      length = len(self.action_goal.goal.request.start_state.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.request.start_state.joint_state.effort))
      _x = self
      ...
      _x = self.action_goal.goal.request.start_state.is_diff
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.request.workspace_parameters.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_goal.goal.request.start_state.joint_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.action_goal.goal.request.start_state.joint_state.position = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.request.start_state.joint_state.velocity = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.request.start_state.joint_state.effort = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_goal.goal.request.start_state.multi_dof_joint_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v167.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v167.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      if python3:
        self.action_goal.goal.request.path_constraints.name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      for i in range(0, length):
        ...
        (_v216.seq,) = _get_struct_I().unpack(str[start:end])
        _v217 = _v216.stamp
        _x = _v217
        start = end
        end += 8
        ...
        if python3:
          _v216.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
      ...
      if python3:
        self.action_goal.goal.request.planner_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_goal.goal.request.group_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v256.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v259.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v259.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v256.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      for i in range(0, length):
        ...
        (_v276.seq,) = _get_struct_I().unpack(str[start:end])
        _v277 = _v276.stamp
        _x = _v277
        start = end
        end += 8
        ...
        if python3:
          _v276.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v278.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v278.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v291.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v294.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v294.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v291.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
        ...
        (_v302.seq,) = _get_struct_I().unpack(str[start:end])
        _v303 = _v302.stamp
        _x = _v303
        start = end
        end += 8
        ...
        if python3:
          _v302.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
      ...
      if python3:
        self.action_result.result.planned_trajectory.joint_trajectory.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_result.result.planned_trajectory.multi_dof_joint_trajectory.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_result.result.executed_trajectory.joint_trajectory.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_result.result.executed_trajectory.multi_dof_joint_trajectory.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v488.seq,) = _get_struct_I().unpack(str[start:end])
        _v489 = _v488.stamp
        _x = _v489
        start = end
        end += 8
        ...
        if python3:
          _v488.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v487.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v490.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v490.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v487.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
        ...
        if python3:
          _v498.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            _v501.frame_id = str[start:end].decode('utf-8', 'rosmsg')
          else:
        ...
        for i in range(0, length):
          ...
          if python3:
            _v513.frame_id = str[start:end].decode('utf-8', 'rosmsg')
          else:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          (_v547.seq,) = _get_struct_I().unpack(str[start:end])
          _v548 = _v547.stamp
          _x = _v548
          start = end
          end += 8
          ...
          if python3:
            _v547.frame_id = str[start:end].decode('utf-8', 'rosmsg')
          else:
        ...
        for i in range(0, length):
          ...
          (_v559.seq,) = _get_struct_I().unpack(str[start:end])
          _v560 = _v559.stamp
          _x = _v560
          start = end
          end += 8
          ...
          if python3:
            _v559.frame_id = str[start:end].decode('utf-8', 'rosmsg')
          else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v576.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v579.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v579.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v576.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      for i in range(0, length):
        ...
        (_v596.seq,) = _get_struct_I().unpack(str[start:end])
        _v597 = _v596.stamp
        _x = _v597
        start = end
        end += 8
        ...
        if python3:
          _v596.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v598.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v598.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v612.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v611.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v614.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v614.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v611.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
