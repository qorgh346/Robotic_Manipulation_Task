...
class MotionPlanDetailedResponse(genpy.Message):
  _md5sum = "7b84c374bb2e37bdc0eba664f7636a8f"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.processing_time))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v41.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v41.id = str[start:end]
        _v44 = _v41.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          _v44.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v44.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v44.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v44.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v41.primitives = []
        for i in range(0, length):
          ...
          _v41.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v41.primitive_poses = []
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v41.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v41.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v41.plane_poses.append(val3)
        start = end
        end += 1
        (_v41.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      for i in range(0, length):
        ...
        _v59 = val1.multi_dof_joint_trajectory
        _v60 = _v59.header
        start = end
        end += 4
      ...
      self.processing_time = s.unpack(str[start:end])
      start = end
      end += 4
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.trajectory_start.attached_collision_objects:
        ...
        buff.write(_struct_I.pack(length))
        for val3 in _v75.primitive_poses:
          _v79 = val3.position
          _x = _v79
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      ...
      for val1 in self.trajectory:
        ...
        for val3 in _v89.points:
          ...
          _x = _v92
          buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
        _v93 = val1.multi_dof_joint_trajectory
        _v94 = _v93.header
        _x = _v94.seq
        buff.write(_get_struct_I().pack(_x))
        _v95 = _v94.stamp
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
          _v123.points.append(val3)
        _v127 = val1.multi_dof_joint_trajectory
        _v128 = _v127.header
        start = end
        end += 4
