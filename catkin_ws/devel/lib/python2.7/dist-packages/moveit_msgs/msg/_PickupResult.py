...
"""autogenerated by genpy from moveit_msgs/PickupResult.msg. Do not edit."""
import codecs
import sys
...
class PickupResult(genpy.Message):
  _md5sum = "23c6d8bf0580f4bc8f7a8e1f59b4b6b7"
  _type = "moveit_msgs/PickupResult"
...
Vector3 vector
"""
  __slots__ = ['error_code','trajectory_start','trajectory_stages','trajectory_descriptions','grasp']
  _slot_types = ['moveit_msgs/MoveItErrorCodes','moveit_msgs/RobotState','moveit_msgs/RobotTrajectory[]','string[]','moveit_msgs/Grasp']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       error_code,trajectory_start,trajectory_stages,trajectory_descriptions,grasp
    ...
    """
    if args or kwds:
      super(PickupResult, self).__init__(*args, **kwds)
