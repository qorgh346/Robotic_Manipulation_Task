...
class PickupActionGoal(genpy.Message):
  _md5sum = "9e12196da542c9a26bbc43e9655a1906"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.goal.minimize_object_distance
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.target_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.goal.end_effector = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      for i in range(0, length):
        ...
        _v119 = val1.target_point_offset
        _x = _v119
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v120 = val1.constraint_region
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v120.primitives = []
        for i in range(0, length):
          ...
          _v120.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v120.primitive_poses = []
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v120.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v120.meshes = []
      ...
      for i in range(0, length):
        ...
        if python3:
          _v146.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v146.id = str[start:end]
        _v149 = _v146.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          _v149.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v149.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v149.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v149.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v146.primitives = []
        for i in range(0, length):
          ...
          val3.dimensions = s.unpack(str[start:end])
          _v146.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v146.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v150 = val3.position
          _x = _v150
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v146.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v146.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v146.plane_poses.append(val3)
        start = end
        end += 1
        (_v146.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      for i in range(0, length):
        ...
        _v162 = val1.transform
        _v163 = _v162.translation
        _x = _v163
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v164 = _v162.rotation
        _x = _v164
        start = end
        end += 32
        (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
    ...
    try:
      ...
      for val1 in self.goal.possible_grasps:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v175.joint_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v175.joint_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v175.points)
        buff.write(_struct_I.pack(length))
        for val3 in _v175.points:
          length = len(val3.positions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v179.joint_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v179.joint_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v179.points)
        buff.write(_struct_I.pack(length))
        for val3 in _v179.points:
          length = len(val3.positions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(val3.positions.tostring())
      ...
      for val1 in self.goal.planning_options.planning_scene_diff.robot_state.attached_collision_objects:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v233.primitives)
        buff.write(_struct_I.pack(length))
        for val3 in _v233.primitives:
          _x = val3.type
          buff.write(_get_struct_B().pack(_x))
          length = len(val3.dimensions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(val3.dimensions.tostring())
        length = len(_v233.primitive_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v233.primitive_poses:
          _v237 = val3.position
          _x = _v237
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v238
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v233.meshes)
        buff.write(_struct_I.pack(length))
        for val3 in _v233.meshes:
          length = len(val3.triangles)
          buff.write(_struct_I.pack(length))
          for val4 in val3.triangles:
            buff.write(val4.vertex_indices.tostring())
          ...
          for val4 in val3.vertices:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v233.mesh_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v233.mesh_poses:
          _v239 = val3.position
          _x = _v239
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v240
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v233.planes)
        buff.write(_struct_I.pack(length))
        for val3 in _v233.planes:
          buff.write(val3.coef.tostring())
        length = len(_v233.plane_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v233.plane_poses:
          _v241 = val3.position
          _x = _v241
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      ...
      for val1 in self.goal.planning_options.planning_scene_diff.fixed_frame_transforms:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _v249 = val1.transform
        _v250 = _v249.translation
        _x = _v250
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v251 = _v249.rotation
        _x = _v251
        buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
      length = len(self.goal.planning_options.planning_scene_diff.allowed_collision_matrix.entry_names)
      buff.write(_struct_I.pack(length))
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          _v265 = val3.time_from_start
          _x = _v265
          start = end
          end += 8
          (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
          _v262.points.append(val3)
        _v266 = val1.grasp_posture
        _v267 = _v266.header
        start = end
        end += 4
        ...
        (val1.grasp_quality,) = _get_struct_d().unpack(str[start:end])
        _v276 = val1.pre_grasp_approach
        _v277 = _v276.direction
        _v278 = _v277.header
        start = end
        end += 4
      ...
      for i in range(0, length):
        ...
        (_v291.seq,) = _get_struct_I().unpack(str[start:end])
        _v292 = _v291.stamp
        _x = _v292
        start = end
        end += 8
        ...
        if python3:
          _v291.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          ...
          val1.link_name = str[start:end]
        _v293 = val1.target_point_offset
        _x = _v293
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v294 = val1.constraint_region
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v294.primitives = []
      ...
      for i in range(0, length):
        ...
        (_v299.seq,) = _get_struct_I().unpack(str[start:end])
        _v300 = _v299.stamp
        _x = _v300
        start = end
        end += 8
        ...
        if python3:
          _v299.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
      ...
      for i in range(0, length):
        ...
        _v311 = _v308.pose
        _v312 = _v311.position
        _x = _v312
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v313 = _v311.orientation
        _x = _v313
        start = end
        end += 32
        (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        if python3:
          _v320.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v320.id = str[start:end]
        _v323 = _v320.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          _v323.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v323.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v323.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v323.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v320.primitives = []
        for i in range(0, length):
          ...
          val3.dimensions = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
          _v320.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v320.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v324 = val3.position
          _x = _v324
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v325 = val3.orientation
          _x = _v325
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v320.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v320.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v327 = val3.orientation
          _x = _v327
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v320.mesh_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v320.planes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v320.plane_poses.append(val3)
        start = end
        end += 1
        (_v320.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
        ...
        for i in range(0, length):
          ...
          val3.effort = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
          _v333 = val3.time_from_start
          _x = _v333
          start = end
          end += 8
          (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
          _v330.points.append(val3)
        start = end
        end += 8
        (val1.weight,) = _get_struct_d().unpack(str[start:end])
        self.goal.planning_options.planning_scene_diff.robot_state.attached_collision_objects.append(val1)
