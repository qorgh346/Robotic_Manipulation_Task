...
"""autogenerated by genpy from moveit_msgs/ContactInformation.msg. Do not edit."""
import codecs
import sys
...
class ContactInformation(genpy.Message):
  _md5sum = "116228ca08b0c286ec5ca32a50fdc17b"
  _type = "moveit_msgs/ContactInformation"
...
float64 z"""
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,position,normal,depth,contact_body_1,body_type_1,contact_body_2,body_type_2
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_7d().pack(_x.position.x, _x.position.y, _x.position.z, _x.normal.x, _x.normal.y, _x.normal.z, _x.depth))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.position.x, _x.position.y, _x.position.z, _x.normal.x, _x.normal.y, _x.normal.z, _x.depth,) = _get_struct_7d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.contact_body_1 = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.contact_body_1 = str[start:end]
      start = end
      end += 4
      (self.body_type_1,) = _get_struct_I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.contact_body_2 = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.contact_body_2 = str[start:end]
      start = end
      end += 4
      (self.body_type_2,) = _get_struct_I().unpack(str[start:end])
      return self
