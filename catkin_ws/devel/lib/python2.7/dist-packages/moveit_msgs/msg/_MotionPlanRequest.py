...
class MotionPlanRequest(genpy.Message):
  _md5sum = "c3bec13a525a6ae66e0fc57b768fdca6"
...
"""
  __slots__ = ['workspace_parameters','start_state','goal_constraints','path_constraints','trajectory_constraints','planner_id','group_name','num_planning_attempts','allowed_planning_time','max_velocity_scaling_factor','max_acceleration_scaling_factor']
  _slot_types = ['moveit_msgs/WorkspaceParameters','moveit_msgs/RobotState','moveit_msgs/Constraints[]','moveit_msgs/Constraints','moveit_msgs/TrajectoryConstraints','string','string','int32','float64','float64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       workspace_parameters,start_state,goal_constraints,path_constraints,trajectory_constraints,planner_id,group_name,num_planning_attempts,allowed_planning_time,max_velocity_scaling_factor,max_acceleration_scaling_factor
