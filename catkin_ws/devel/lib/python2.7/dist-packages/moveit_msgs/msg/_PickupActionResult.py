...
"""autogenerated by genpy from moveit_msgs/PickupActionResult.msg. Do not edit."""
import codecs
import sys
...
class PickupActionResult(genpy.Message):
  _md5sum = "9a2192bdd4f78c9d7c479e4a43f2768f"
  _type = "moveit_msgs/PickupActionResult"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = moveit_msgs.msg.PickupResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = moveit_msgs.msg.PickupResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.result.grasp.pre_grasp_posture.header.seq, _x.result.grasp.pre_grasp_posture.header.stamp.secs, _x.result.grasp.pre_grasp_posture.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.result.grasp.pre_grasp_posture.joint_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.grasp.pre_grasp_posture.joint_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      length = len(self.result.grasp.pre_grasp_posture.points)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.grasp.pre_grasp_posture.points:
        ...
        buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
      _x = self
      buff.write(_get_struct_3I().pack(_x.result.grasp.grasp_posture.header.seq, _x.result.grasp.grasp_posture.header.stamp.secs, _x.result.grasp.grasp_posture.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.result.grasp.grasp_posture.joint_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.grasp.grasp_posture.joint_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      length = len(self.result.grasp.grasp_posture.points)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.grasp.grasp_posture.points:
        length = len(val1.positions)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.Struct(pattern).pack(*val1.positions))
        ...
        buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
      _x = self
      buff.write(_get_struct_3I().pack(_x.result.grasp.grasp_pose.header.seq, _x.result.grasp.grasp_pose.header.stamp.secs, _x.result.grasp.grasp_pose.header.stamp.nsecs))
      _x = self.result.grasp.grasp_pose.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      _x = self.result.grasp.pre_grasp_approach.direction.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3d2f3I().pack(_x.result.grasp.pre_grasp_approach.direction.vector.x, _x.result.grasp.pre_grasp_approach.direction.vector.y, _x.result.grasp.pre_grasp_approach.direction.vector.z, _x.result.grasp.pre_grasp_approach.desired_distance, _x.result.grasp.pre_grasp_approach.min_distance, _x.result.grasp.post_grasp_retreat.direction.header.seq, _x.result.grasp.post_grasp_retreat.direction.header.stamp.secs, _x.result.grasp.post_grasp_retreat.direction.header.stamp.nsecs))
      _x = self.result.grasp.post_grasp_retreat.direction.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3d2f3I().pack(_x.result.grasp.post_grasp_retreat.direction.vector.x, _x.result.grasp.post_grasp_retreat.direction.vector.y, _x.result.grasp.post_grasp_retreat.direction.vector.z, _x.result.grasp.post_grasp_retreat.desired_distance, _x.result.grasp.post_grasp_retreat.min_distance, _x.result.grasp.post_place_retreat.direction.header.seq, _x.result.grasp.post_place_retreat.direction.header.stamp.secs, _x.result.grasp.post_place_retreat.direction.header.stamp.nsecs))
      _x = self.result.grasp.post_place_retreat.direction.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3d3f().pack(_x.result.grasp.post_place_retreat.direction.vector.x, _x.result.grasp.post_place_retreat.direction.vector.y, _x.result.grasp.post_place_retreat.direction.vector.z, _x.result.grasp.post_place_retreat.desired_distance, _x.result.grasp.post_place_retreat.min_distance, _x.result.grasp.max_contact_force))
      length = len(self.result.grasp.allowed_touch_objects)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.grasp.allowed_touch_objects:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v43.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
      ...
      if python3:
        self.result.grasp.id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.result.grasp.id = str[start:end]
      _x = self
      start = end
      end += 12
      (_x.result.grasp.pre_grasp_posture.header.seq, _x.result.grasp.pre_grasp_posture.header.stamp.secs, _x.result.grasp.pre_grasp_posture.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.grasp.pre_grasp_posture.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.result.grasp.pre_grasp_posture.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.grasp.pre_grasp_posture.joint_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.result.grasp.pre_grasp_posture.joint_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.grasp.pre_grasp_posture.points = []
      for i in range(0, length):
        ...
        (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
        self.result.grasp.pre_grasp_posture.points.append(val1)
      _x = self
      start = end
      end += 12
      (_x.result.grasp.grasp_posture.header.seq, _x.result.grasp.grasp_posture.header.stamp.secs, _x.result.grasp.grasp_posture.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.grasp.grasp_posture.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.result.grasp.grasp_posture.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.grasp.grasp_posture.joint_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.result.grasp.grasp_posture.joint_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.grasp.grasp_posture.points = []
      for i in range(0, length):
        val1 = trajectory_msgs.msg.JointTrajectoryPoint()
        start = end
        end += 4
        ...
        (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
        self.result.grasp.grasp_posture.points.append(val1)
      _x = self
      start = end
      end += 12
      (_x.result.grasp.grasp_pose.header.seq, _x.result.grasp.grasp_pose.header.stamp.secs, _x.result.grasp.grasp_pose.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.grasp.grasp_pose.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.result.grasp.grasp_pose.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 76
      ...
      if python3:
        self.result.grasp.pre_grasp_approach.direction.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.result.grasp.pre_grasp_approach.direction.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 44
      (_x.result.grasp.pre_grasp_approach.direction.vector.x, _x.result.grasp.pre_grasp_approach.direction.vector.y, _x.result.grasp.pre_grasp_approach.direction.vector.z, _x.result.grasp.pre_grasp_approach.desired_distance, _x.result.grasp.pre_grasp_approach.min_distance, _x.result.grasp.post_grasp_retreat.direction.header.seq, _x.result.grasp.post_grasp_retreat.direction.header.stamp.secs, _x.result.grasp.post_grasp_retreat.direction.header.stamp.nsecs,) = _get_struct_3d2f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.grasp.post_grasp_retreat.direction.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.result.grasp.post_grasp_retreat.direction.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 44
      (_x.result.grasp.post_grasp_retreat.direction.vector.x, _x.result.grasp.post_grasp_retreat.direction.vector.y, _x.result.grasp.post_grasp_retreat.direction.vector.z, _x.result.grasp.post_grasp_retreat.desired_distance, _x.result.grasp.post_grasp_retreat.min_distance, _x.result.grasp.post_place_retreat.direction.header.seq, _x.result.grasp.post_place_retreat.direction.header.stamp.secs, _x.result.grasp.post_place_retreat.direction.header.stamp.nsecs,) = _get_struct_3d2f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.grasp.post_place_retreat.direction.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.result.grasp.post_place_retreat.direction.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 36
      (_x.result.grasp.post_place_retreat.direction.vector.x, _x.result.grasp.post_place_retreat.direction.vector.y, _x.result.grasp.post_place_retreat.direction.vector.z, _x.result.grasp.post_place_retreat.desired_distance, _x.result.grasp.post_place_retreat.min_distance, _x.result.grasp.max_contact_force,) = _get_struct_3d3f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.grasp.allowed_touch_objects = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.result.grasp.allowed_touch_objects.append(val1)
      return self
    ...
    try:
      ...
      for val1 in self.result.trajectory_stages:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v93.joint_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v93.joint_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
        ...
        for val3 in _v93.points:
          ...
          _x = _v96
          buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
        _v97 = val1.multi_dof_joint_trajectory
        _v98 = _v97.header
        _x = _v98.seq
        buff.write(_get_struct_I().pack(_x))
        _v99 = _v98.stamp
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v115.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v118.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v118.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        for i in range(0, length):
          ...
          _v128 = val3.time_from_start
          _x = _v128
          start = end
          end += 8
          (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
          _v125.points.append(val3)
        start = end
        end += 8
        (val1.weight,) = _get_struct_d().unpack(str[start:end])
        self.result.trajectory_start.attached_collision_objects.append(val1)
      ...
      for i in range(0, length):
        ...
        _v133 = val1.multi_dof_joint_trajectory
        _v134 = _v133.header
        start = end
        end += 4
