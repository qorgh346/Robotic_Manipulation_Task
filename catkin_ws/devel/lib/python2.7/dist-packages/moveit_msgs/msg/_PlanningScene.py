...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.Struct(pattern).pack(*self.allowed_collision_matrix.default_entry_values))
      ...
      for val1 in self.world.collision_objects:
        ...
        buff.write(_get_struct_b().pack(_x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.world.octomap.header.seq, _x.world.octomap.header.stamp.secs, _x.world.octomap.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.world.octomap.octomap.binary
      buff.write(_get_struct_B().pack(_x))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.world.octomap.octomap.resolution
      buff.write(_get_struct_d().pack(_x))
      length = len(self.world.octomap.octomap.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sb'%length
      buff.write(struct.Struct(pattern).pack(*self.world.octomap.octomap.data))
      _x = self.is_diff
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.robot_model_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.allowed_collision_matrix.default_entry_values = s.unpack(str[start:end])
      self.allowed_collision_matrix.default_entry_values = list(map(bool, self.allowed_collision_matrix.default_entry_values))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.link_padding = []
      ...
      (_x.world.octomap.header.seq, _x.world.octomap.header.stamp.secs, _x.world.octomap.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.world.octomap.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.world.octomap.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 68
      (_x.world.octomap.origin.position.x, _x.world.octomap.origin.position.y, _x.world.octomap.origin.position.z, _x.world.octomap.origin.orientation.x, _x.world.octomap.origin.orientation.y, _x.world.octomap.origin.orientation.z, _x.world.octomap.origin.orientation.w, _x.world.octomap.octomap.header.seq, _x.world.octomap.octomap.header.stamp.secs, _x.world.octomap.octomap.header.stamp.nsecs,) = _get_struct_7d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.world.octomap.octomap.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.world.octomap.octomap.header.frame_id = str[start:end]
      start = end
      end += 1
      (self.world.octomap.octomap.binary,) = _get_struct_B().unpack(str[start:end])
      ...
      if python3:
        self.world.octomap.octomap.id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.world.octomap.octomap.id = str[start:end]
      start = end
      end += 8
      (self.world.octomap.octomap.resolution,) = _get_struct_d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sb'%length
      ...
      self.world.octomap.octomap.data = s.unpack(str[start:end])
      start = end
      end += 1
      (self.is_diff,) = _get_struct_B().unpack(str[start:end])
