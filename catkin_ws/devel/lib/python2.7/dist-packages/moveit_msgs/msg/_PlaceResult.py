...
"""autogenerated by genpy from moveit_msgs/PlaceResult.msg. Do not edit."""
import codecs
import sys
...
class PlaceResult(genpy.Message):
  _md5sum = "da2eea14de05cf0aa280f150a84ded50"
  _type = "moveit_msgs/PlaceResult"
...
Vector3 vector
"""
  __slots__ = ['error_code','trajectory_start','trajectory_stages','trajectory_descriptions','place_location']
  _slot_types = ['moveit_msgs/MoveItErrorCodes','moveit_msgs/RobotState','moveit_msgs/RobotTrajectory[]','string[]','moveit_msgs/PlaceLocation']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       error_code,trajectory_start,trajectory_stages,trajectory_descriptions,place_location
    ...
    if args or kwds:
      ...
      if self.trajectory_stages is None:
        self.trajectory_stages = []
      if self.trajectory_descriptions is None:
        self.trajectory_descriptions = []
      if self.place_location is None:
        self.place_location = moveit_msgs.msg.PlaceLocation()
    else:
      self.error_code = moveit_msgs.msg.MoveItErrorCodes()
      self.trajectory_start = moveit_msgs.msg.RobotState()
      self.trajectory_stages = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_B().pack(_x))
      length = len(self.trajectory_stages)
      buff.write(_struct_I.pack(length))
      for val1 in self.trajectory_stages:
        ...
        for val3 in _v25.points:
          ...
          _x = _v34
          buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
      length = len(self.trajectory_descriptions)
      buff.write(_struct_I.pack(length))
      for val1 in self.trajectory_descriptions:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      _x = self.place_location.id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.place_location.post_place_posture.header.seq, _x.place_location.post_place_posture.header.stamp.secs, _x.place_location.post_place_posture.header.stamp.nsecs))
      _x = self.place_location.post_place_posture.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.place_location.post_place_posture.joint_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.place_location.post_place_posture.joint_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      length = len(self.place_location.post_place_posture.points)
      buff.write(_struct_I.pack(length))
      for val1 in self.place_location.post_place_posture.points:
        ...
        buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
      _x = self
      buff.write(_get_struct_3I().pack(_x.place_location.place_pose.header.seq, _x.place_location.place_pose.header.stamp.secs, _x.place_location.place_pose.header.stamp.nsecs))
      _x = self.place_location.place_pose.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7d3I().pack(_x.place_location.place_pose.pose.position.x, _x.place_location.place_pose.pose.position.y, _x.place_location.place_pose.pose.position.z, _x.place_location.place_pose.pose.orientation.x, _x.place_location.place_pose.pose.orientation.y, _x.place_location.place_pose.pose.orientation.z, _x.place_location.place_pose.pose.orientation.w, _x.place_location.pre_place_approach.direction.header.seq, _x.place_location.pre_place_approach.direction.header.stamp.secs, _x.place_location.pre_place_approach.direction.header.stamp.nsecs))
      _x = self.place_location.pre_place_approach.direction.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3d2f3I().pack(_x.place_location.pre_place_approach.direction.vector.x, _x.place_location.pre_place_approach.direction.vector.y, _x.place_location.pre_place_approach.direction.vector.z, _x.place_location.pre_place_approach.desired_distance, _x.place_location.pre_place_approach.min_distance, _x.place_location.post_place_retreat.direction.header.seq, _x.place_location.post_place_retreat.direction.header.stamp.secs, _x.place_location.post_place_retreat.direction.header.stamp.nsecs))
      _x = self.place_location.post_place_retreat.direction.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3d2f().pack(_x.place_location.post_place_retreat.direction.vector.x, _x.place_location.post_place_retreat.direction.vector.y, _x.place_location.post_place_retreat.direction.vector.z, _x.place_location.post_place_retreat.desired_distance, _x.place_location.post_place_retreat.min_distance))
      length = len(self.place_location.allowed_touch_objects)
      buff.write(_struct_I.pack(length))
      for val1 in self.place_location.allowed_touch_objects:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.trajectory_stages.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.trajectory_descriptions = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.trajectory_descriptions.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.place_location.id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.place_location.id = str[start:end]
      _x = self
      start = end
      end += 12
      (_x.place_location.post_place_posture.header.seq, _x.place_location.post_place_posture.header.stamp.secs, _x.place_location.post_place_posture.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.place_location.post_place_posture.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.place_location.post_place_posture.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.place_location.post_place_posture.joint_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.place_location.post_place_posture.joint_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.place_location.post_place_posture.points = []
      for i in range(0, length):
        ...
        (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
        self.place_location.post_place_posture.points.append(val1)
      _x = self
      start = end
      end += 12
      (_x.place_location.place_pose.header.seq, _x.place_location.place_pose.header.stamp.secs, _x.place_location.place_pose.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.place_location.place_pose.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.place_location.place_pose.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 68
      (_x.place_location.place_pose.pose.position.x, _x.place_location.place_pose.pose.position.y, _x.place_location.place_pose.pose.position.z, _x.place_location.place_pose.pose.orientation.x, _x.place_location.place_pose.pose.orientation.y, _x.place_location.place_pose.pose.orientation.z, _x.place_location.place_pose.pose.orientation.w, _x.place_location.pre_place_approach.direction.header.seq, _x.place_location.pre_place_approach.direction.header.stamp.secs, _x.place_location.pre_place_approach.direction.header.stamp.nsecs,) = _get_struct_7d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.place_location.pre_place_approach.direction.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.place_location.pre_place_approach.direction.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 44
      (_x.place_location.pre_place_approach.direction.vector.x, _x.place_location.pre_place_approach.direction.vector.y, _x.place_location.pre_place_approach.direction.vector.z, _x.place_location.pre_place_approach.desired_distance, _x.place_location.pre_place_approach.min_distance, _x.place_location.post_place_retreat.direction.header.seq, _x.place_location.post_place_retreat.direction.header.stamp.secs, _x.place_location.post_place_retreat.direction.header.stamp.nsecs,) = _get_struct_3d2f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.place_location.post_place_retreat.direction.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.place_location.post_place_retreat.direction.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 32
      (_x.place_location.post_place_retreat.direction.vector.x, _x.place_location.post_place_retreat.direction.vector.y, _x.place_location.post_place_retreat.direction.vector.z, _x.place_location.post_place_retreat.desired_distance, _x.place_location.post_place_retreat.min_distance,) = _get_struct_3d2f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.place_location.allowed_touch_objects = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.place_location.allowed_touch_objects.append(val1)
      return self
