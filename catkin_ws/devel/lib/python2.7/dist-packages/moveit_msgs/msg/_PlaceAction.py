  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v163.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v166.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v166.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v163.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      for i in range(0, length):
        ...
        if python3:
          _v198.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v201.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v201.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v198.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      for i in range(0, length):
        ...
        if python3:
          _v217.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v341.seq,) = _get_struct_I().unpack(str[start:end])
        _v342 = _v341.stamp
        _x = _v342
        start = end
        end += 8
        ...
        if python3:
          _v341.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v345.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v368.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v389.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v392.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v392.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v389.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      for i in range(0, length):
        ...
        if python3:
          _v411.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v411.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v424.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v427.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v427.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v424.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      for i in range(0, length):
        ...
        (_v443.seq,) = _get_struct_I().unpack(str[start:end])
        _v444 = _v443.stamp
        _x = _v444
        start = end
        end += 8
        ...
        if python3:
          _v443.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
