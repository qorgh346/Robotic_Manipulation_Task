...
class CollisionObject(genpy.Message):
  _md5sum = "568a161b26dc46c54a5a07621ce82cf3"
...
"""
  ...
  __slots__ = ['header','id','type','primitives','primitive_poses','meshes','mesh_poses','planes','plane_poses','operation']
  _slot_types = ['std_msgs/Header','string','object_recognition_msgs/ObjectType','shape_msgs/SolidPrimitive[]','geometry_msgs/Pose[]','shape_msgs/Mesh[]','geometry_msgs/Pose[]','shape_msgs/Plane[]','geometry_msgs/Pose[]','byte']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,id,type,primitives,primitive_poses,meshes,mesh_poses,planes,plane_poses,operation
