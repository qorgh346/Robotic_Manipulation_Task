...
class MoveGroupResult(genpy.Message):
  _md5sum = "34098589d402fee7ae9c3fd413e5a6c6"
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.planned_trajectory.joint_trajectory.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.planned_trajectory.multi_dof_joint_trajectory.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.executed_trajectory.joint_trajectory.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.executed_trajectory.multi_dof_joint_trajectory.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
