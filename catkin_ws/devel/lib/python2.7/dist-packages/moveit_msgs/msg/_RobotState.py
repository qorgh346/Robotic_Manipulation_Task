...
"""autogenerated by genpy from moveit_msgs/RobotState.msg. Do not edit."""
import codecs
import sys
...
class RobotState(genpy.Message):
  _md5sum = "217a2e8e5547f4162b13a37db9cb4da4"
  _type = "moveit_msgs/RobotState"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.multi_dof_joint_state is None:
        self.multi_dof_joint_state = sensor_msgs.msg.MultiDOFJointState()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3I().pack(_x.multi_dof_joint_state.header.seq, _x.multi_dof_joint_state.header.stamp.secs, _x.multi_dof_joint_state.header.stamp.nsecs))
      _x = self.multi_dof_joint_state.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      for val1 in self.multi_dof_joint_state.joint_names:
        ...
        if python3 or type(val1) == unicode:
          ...
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      length = len(self.multi_dof_joint_state.transforms)
      buff.write(_struct_I.pack(length))
      for val1 in self.multi_dof_joint_state.transforms:
      ...
      length = len(self.multi_dof_joint_state.twist)
      buff.write(_struct_I.pack(length))
      for val1 in self.multi_dof_joint_state.twist:
        _v3 = val1.linear
        _x = _v3
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v4 = val1.angular
        _x = _v4
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.multi_dof_joint_state.wrench)
      buff.write(_struct_I.pack(length))
      for val1 in self.multi_dof_joint_state.wrench:
        _v5 = val1.force
        _x = _v5
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v6 = val1.torque
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.multi_dof_joint_state.header.seq, _x.multi_dof_joint_state.header.stamp.secs, _x.multi_dof_joint_state.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.multi_dof_joint_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.multi_dof_joint_state.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.multi_dof_joint_state.transforms = []
      for i in range(0, length):
        ...
        self.multi_dof_joint_state.transforms.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.multi_dof_joint_state.twist = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.multi_dof_joint_state.twist.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.multi_dof_joint_state.wrench = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.multi_dof_joint_state.wrench.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.attached_collision_objects = []
      for i in range(0, length):
        ...
        if python3:
          _v27.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v30.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v30.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v27.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v67.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v70.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v70.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v67.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
