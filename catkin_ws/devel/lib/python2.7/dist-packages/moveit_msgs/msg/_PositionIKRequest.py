...
"""autogenerated by genpy from moveit_msgs/PositionIKRequest.msg. Do not edit."""
import codecs
import sys
...
class PositionIKRequest(genpy.Message):
  _md5sum = "9936dc239c90af180ec94a51596c96f2"
  _type = "moveit_msgs/PositionIKRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# A Position IK request message
...
Pose pose
"""
  __slots__ = ['group_name','robot_state','constraints','avoid_collisions','ik_link_name','pose_stamped','ik_link_names','pose_stamped_vector','timeout','attempts']
  _slot_types = ['string','moveit_msgs/RobotState','moveit_msgs/Constraints','bool','string','geometry_msgs/PoseStamped','string[]','geometry_msgs/PoseStamped[]','duration','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       group_name,robot_state,constraints,avoid_collisions,ik_link_name,pose_stamped,ik_link_names,pose_stamped_vector,timeout,attempts
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.ik_link_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_link_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      length = len(self.pose_stamped_vector)
      buff.write(_struct_I.pack(length))
      for val1 in self.pose_stamped_vector:
        _v44 = val1.header
        _x = _v44.seq
        buff.write(_get_struct_I().pack(_x))
        _v45 = _v44.stamp
        ...
        buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
      _x = self
      buff.write(_get_struct_3i().pack(_x.timeout.secs, _x.timeout.nsecs, _x.attempts))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.avoid_collisions,) = _get_struct_B().unpack(str[start:end])
      ...
      if python3:
        self.ik_link_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.ik_link_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.pose_stamped_vector = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
        self.pose_stamped_vector.append(val1)
      _x = self
      start = end
      end += 12
      (_x.timeout.secs, _x.timeout.nsecs, _x.attempts,) = _get_struct_3i().unpack(str[start:end])
      self.timeout.canon()
      return self
