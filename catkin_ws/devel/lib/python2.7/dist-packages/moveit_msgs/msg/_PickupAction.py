...
"""autogenerated by genpy from moveit_msgs/PickupAction.msg. Do not edit."""
import codecs
import sys
...
class PickupAction(genpy.Message):
  _md5sum = "f5aa574f57e5d9cf7d466d5913039489"
  _type = "moveit_msgs/PickupAction"
...
"""
  ...
  _slot_types = ['moveit_msgs/PickupActionGoal','moveit_msgs/PickupActionResult','moveit_msgs/PickupActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = moveit_msgs.msg.PickupActionGoal()
      if self.action_result is None:
        self.action_result = moveit_msgs.msg.PickupActionResult()
      if self.action_feedback is None:
        self.action_feedback = moveit_msgs.msg.PickupActionFeedback()
    else:
      self.action_goal = moveit_msgs.msg.PickupActionGoal()
      self.action_result = moveit_msgs.msg.PickupActionResult()
      self.action_feedback = moveit_msgs.msg.PickupActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.end_effector
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      length = len(self.action_goal.goal.attached_object_touch_links)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.attached_object_touch_links:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      _x = self.action_goal.goal.minimize_object_distance
      buff.write(_get_struct_B().pack(_x))
      ...
      for val1 in self.action_result.result.trajectory_start.attached_collision_objects:
        ...
        buff.write(_struct_I.pack(length))
        for val3 in _v94.primitive_poses:
          _v98 = val3.position
          _x = _v98
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        ...
        buff.write(_struct_I.pack(length))
        for val3 in _v94.planes:
          buff.write(_get_struct_4d().pack(*val3.coef))
        length = len(_v94.plane_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v94.plane_poses:
          _v102 = val3.position
          _x = _v102
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      ...
      for val1 in self.action_result.result.trajectory_stages:
        ...
        for val3 in _v108.points:
          ...
          _x = _v111
          buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
        _v112 = val1.multi_dof_joint_trajectory
        _v113 = _v112.header
        _x = _v113.seq
        buff.write(_get_struct_I().pack(_x))
        _v114 = _v113.stamp
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_result.result.grasp.pre_grasp_posture.header.seq, _x.action_result.result.grasp.pre_grasp_posture.header.stamp.secs, _x.action_result.result.grasp.pre_grasp_posture.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.action_result.result.grasp.pre_grasp_posture.joint_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.grasp.pre_grasp_posture.joint_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      length = len(self.action_result.result.grasp.pre_grasp_posture.points)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.grasp.pre_grasp_posture.points:
        ...
        _v122 = val1.time_from_start
        _x = _v122
        buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_result.result.grasp.grasp_posture.header.seq, _x.action_result.result.grasp.grasp_posture.header.stamp.secs, _x.action_result.result.grasp.grasp_posture.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.action_result.result.grasp.grasp_posture.joint_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.grasp.grasp_posture.joint_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      length = len(self.action_result.result.grasp.grasp_posture.points)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.grasp.grasp_posture.points:
        length = len(val1.positions)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.Struct(pattern).pack(*val1.positions))
        ...
        buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_result.result.grasp.grasp_pose.header.seq, _x.action_result.result.grasp.grasp_pose.header.stamp.secs, _x.action_result.result.grasp.grasp_pose.header.stamp.nsecs))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_8d3I().pack(_x.action_result.result.grasp.grasp_pose.pose.position.x, _x.action_result.result.grasp.grasp_pose.pose.position.y, _x.action_result.result.grasp.grasp_pose.pose.position.z, _x.action_result.result.grasp.grasp_pose.pose.orientation.x, _x.action_result.result.grasp.grasp_pose.pose.orientation.y, _x.action_result.result.grasp.grasp_pose.pose.orientation.z, _x.action_result.result.grasp.grasp_pose.pose.orientation.w, _x.action_result.result.grasp.grasp_quality, _x.action_result.result.grasp.pre_grasp_approach.direction.header.seq, _x.action_result.result.grasp.pre_grasp_approach.direction.header.stamp.secs, _x.action_result.result.grasp.pre_grasp_approach.direction.header.stamp.nsecs))
      _x = self.action_result.result.grasp.pre_grasp_approach.direction.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3d2f3I().pack(_x.action_result.result.grasp.pre_grasp_approach.direction.vector.x, _x.action_result.result.grasp.pre_grasp_approach.direction.vector.y, _x.action_result.result.grasp.pre_grasp_approach.direction.vector.z, _x.action_result.result.grasp.pre_grasp_approach.desired_distance, _x.action_result.result.grasp.pre_grasp_approach.min_distance, _x.action_result.result.grasp.post_grasp_retreat.direction.header.seq, _x.action_result.result.grasp.post_grasp_retreat.direction.header.stamp.secs, _x.action_result.result.grasp.post_grasp_retreat.direction.header.stamp.nsecs))
      _x = self.action_result.result.grasp.post_grasp_retreat.direction.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3d2f3I().pack(_x.action_result.result.grasp.post_grasp_retreat.direction.vector.x, _x.action_result.result.grasp.post_grasp_retreat.direction.vector.y, _x.action_result.result.grasp.post_grasp_retreat.direction.vector.z, _x.action_result.result.grasp.post_grasp_retreat.desired_distance, _x.action_result.result.grasp.post_grasp_retreat.min_distance, _x.action_result.result.grasp.post_place_retreat.direction.header.seq, _x.action_result.result.grasp.post_place_retreat.direction.header.stamp.secs, _x.action_result.result.grasp.post_place_retreat.direction.header.stamp.nsecs))
      _x = self.action_result.result.grasp.post_place_retreat.direction.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3d3f().pack(_x.action_result.result.grasp.post_place_retreat.direction.vector.x, _x.action_result.result.grasp.post_place_retreat.direction.vector.y, _x.action_result.result.grasp.post_place_retreat.direction.vector.z, _x.action_result.result.grasp.post_place_retreat.desired_distance, _x.action_result.result.grasp.post_place_retreat.min_distance, _x.action_result.result.grasp.max_contact_force))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.target_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.target_name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.end_effector = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.end_effector = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        if python3:
          _v129.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        _v138 = val1.pre_grasp_approach
        _v139 = _v138.direction
        _v140 = _v139.header
        start = end
        end += 4
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.attached_object_touch_links = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.attached_object_touch_links.append(val1)
      start = end
      end += 1
      (self.action_goal.goal.minimize_object_distance,) = _get_struct_B().unpack(str[start:end])
      self.action_goal.goal.minimize_object_distance = bool(self.action_goal.goal.minimize_object_distance)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      for i in range(0, length):
        ...
        _v155 = val1.target_point_offset
        _x = _v155
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v156 = val1.constraint_region
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v156.primitives = []
      ...
      for i in range(0, length):
        ...
        if python3:
          _v182.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v182.id = str[start:end]
        _v185 = _v182.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          _v185.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v185.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        for i in range(0, length):
          ...
          val3.dimensions = s.unpack(str[start:end])
          _v182.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v182.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v186 = val3.position
          _x = _v186
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v182.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v182.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v182.plane_poses.append(val3)
        start = end
        end += 1
        (_v182.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
        ...
        for i in range(0, length):
          ...
          val3.effort = s.unpack(str[start:end])
          _v195 = val3.time_from_start
          _x = _v195
          start = end
          end += 8
          (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
          _v192.points.append(val3)
        start = end
        end += 8
        (val1.weight,) = _get_struct_d().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        _v198 = val1.transform
        _v199 = _v198.translation
        _x = _v199
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v200 = _v198.rotation
        _x = _v200
        start = end
        end += 32
        (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        if python3:
          _v204.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v204.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v204.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v204.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.primitives = []
      ...
      for i in range(0, length):
        ...
        if python3:
          _v217.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v220.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v220.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v217.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v217.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v226 = val3.orientation
          _x = _v226
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v217.plane_poses.append(val3)
        start = end
        end += 1
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          val3.effort = s.unpack(str[start:end])
          _v234 = val3.time_from_start
          _x = _v234
          start = end
          end += 8
          (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
          _v231.points.append(val3)
        _v235 = val1.multi_dof_joint_trajectory
        _v236 = _v235.header
        start = end
        end += 4
      ...
      if python3:
        self.action_result.result.grasp.id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_result.result.grasp.id = str[start:end]
      _x = self
      start = end
      end += 12
      (_x.action_result.result.grasp.pre_grasp_posture.header.seq, _x.action_result.result.grasp.pre_grasp_posture.header.stamp.secs, _x.action_result.result.grasp.pre_grasp_posture.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.grasp.pre_grasp_posture.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_result.result.grasp.pre_grasp_posture.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.grasp.pre_grasp_posture.joint_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_result.result.grasp.pre_grasp_posture.joint_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.grasp.pre_grasp_posture.points = []
      for i in range(0, length):
        ...
        _v245 = val1.time_from_start
        _x = _v245
        start = end
        end += 8
        (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
        self.action_result.result.grasp.pre_grasp_posture.points.append(val1)
      _x = self
      start = end
      end += 12
      (_x.action_result.result.grasp.grasp_posture.header.seq, _x.action_result.result.grasp.grasp_posture.header.stamp.secs, _x.action_result.result.grasp.grasp_posture.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.grasp.grasp_posture.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_result.result.grasp.grasp_posture.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.grasp.grasp_posture.joint_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_result.result.grasp.grasp_posture.joint_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.grasp.grasp_posture.points = []
      for i in range(0, length):
        val1 = trajectory_msgs.msg.JointTrajectoryPoint()
        start = end
        end += 4
        ...
        val1.effort = s.unpack(str[start:end])
        _v246 = val1.time_from_start
        _x = _v246
        start = end
        end += 8
        (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
        self.action_result.result.grasp.grasp_posture.points.append(val1)
      _x = self
      start = end
      end += 12
      (_x.action_result.result.grasp.grasp_pose.header.seq, _x.action_result.result.grasp.grasp_pose.header.stamp.secs, _x.action_result.result.grasp.grasp_pose.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.grasp.grasp_pose.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_result.result.grasp.pre_grasp_approach.direction.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_result.result.grasp.pre_grasp_approach.direction.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 44
      (_x.action_result.result.grasp.pre_grasp_approach.direction.vector.x, _x.action_result.result.grasp.pre_grasp_approach.direction.vector.y, _x.action_result.result.grasp.pre_grasp_approach.direction.vector.z, _x.action_result.result.grasp.pre_grasp_approach.desired_distance, _x.action_result.result.grasp.pre_grasp_approach.min_distance, _x.action_result.result.grasp.post_grasp_retreat.direction.header.seq, _x.action_result.result.grasp.post_grasp_retreat.direction.header.stamp.secs, _x.action_result.result.grasp.post_grasp_retreat.direction.header.stamp.nsecs,) = _get_struct_3d2f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.grasp.post_grasp_retreat.direction.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_result.result.grasp.post_grasp_retreat.direction.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 44
      (_x.action_result.result.grasp.post_grasp_retreat.direction.vector.x, _x.action_result.result.grasp.post_grasp_retreat.direction.vector.y, _x.action_result.result.grasp.post_grasp_retreat.direction.vector.z, _x.action_result.result.grasp.post_grasp_retreat.desired_distance, _x.action_result.result.grasp.post_grasp_retreat.min_distance, _x.action_result.result.grasp.post_place_retreat.direction.header.seq, _x.action_result.result.grasp.post_place_retreat.direction.header.stamp.secs, _x.action_result.result.grasp.post_place_retreat.direction.header.stamp.nsecs,) = _get_struct_3d2f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.grasp.post_place_retreat.direction.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_result.result.grasp.post_place_retreat.direction.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 36
      (_x.action_result.result.grasp.post_place_retreat.direction.vector.x, _x.action_result.result.grasp.post_place_retreat.direction.vector.y, _x.action_result.result.grasp.post_place_retreat.direction.vector.z, _x.action_result.result.grasp.post_place_retreat.desired_distance, _x.action_result.result.grasp.post_place_retreat.min_distance, _x.action_result.result.grasp.max_contact_force,) = _get_struct_3d3f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
    ...
    try:
      ...
      for val1 in self.action_goal.goal.possible_grasps:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v247.joint_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v247.joint_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
        ...
        _x = val1.grasp_quality
        buff.write(_get_struct_d().pack(_x))
        _v261 = val1.pre_grasp_approach
        _v262 = _v261.direction
        _v263 = _v262.header
        _x = _v263.seq
        buff.write(_get_struct_I().pack(_x))
        _v264 = _v263.stamp
        ...
        _x = _v261
        buff.write(_get_struct_2f().pack(_x.desired_distance, _x.min_distance))
        _v266 = val1.post_grasp_retreat
        _v267 = _v266.direction
        _v268 = _v267.header
        _x = _v268.seq
        buff.write(_get_struct_I().pack(_x))
        _v269 = _v268.stamp
        ...
        _x = _v266
        buff.write(_get_struct_2f().pack(_x.desired_distance, _x.min_distance))
        _v271 = val1.post_place_retreat
        _v272 = _v271.direction
        _v273 = _v272.header
        _x = _v273.seq
        buff.write(_get_struct_I().pack(_x))
        _v274 = _v273.stamp
      ...
      for val1 in self.action_goal.goal.path_constraints.position_constraints:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _v278 = val1.target_point_offset
        _x = _v278
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v279 = val1.constraint_region
        length = len(_v279.primitives)
        buff.write(_struct_I.pack(length))
        for val3 in _v279.primitives:
          _x = val3.type
          buff.write(_get_struct_B().pack(_x))
          length = len(val3.dimensions)
          buff.write(_struct_I.pack(length))
        ...
        length = len(_v279.primitive_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v279.primitive_poses:
          _v280 = val3.position
          _x = _v280
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v281
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v279.meshes)
        buff.write(_struct_I.pack(length))
        for val3 in _v279.meshes:
          length = len(val3.triangles)
          buff.write(_struct_I.pack(length))
          for val4 in val3.triangles:
          ...
          for val4 in val3.vertices:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v279.mesh_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v279.mesh_poses:
          _v282 = val3.position
          _x = _v282
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      ...
      for val1 in self.action_goal.goal.planning_options.planning_scene_diff.robot_state.attached_collision_objects:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v305.primitives)
        buff.write(_struct_I.pack(length))
        for val3 in _v305.primitives:
          _x = val3.type
          buff.write(_get_struct_B().pack(_x))
          length = len(val3.dimensions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(val3.dimensions.tostring())
        length = len(_v305.primitive_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v305.primitive_poses:
          _v309 = val3.position
          _x = _v309
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v310
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v305.meshes)
        buff.write(_struct_I.pack(length))
        for val3 in _v305.meshes:
          length = len(val3.triangles)
          buff.write(_struct_I.pack(length))
          for val4 in val3.triangles:
            buff.write(val4.vertex_indices.tostring())
          ...
          for val4 in val3.vertices:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v305.mesh_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v305.mesh_poses:
          _v311 = val3.position
          _x = _v311
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v312
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v305.planes)
        buff.write(_struct_I.pack(length))
        for val3 in _v305.planes:
          buff.write(val3.coef.tostring())
        length = len(_v305.plane_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v305.plane_poses:
          _v313 = val3.position
          _x = _v313
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      ...
      for val1 in self.action_goal.goal.planning_options.planning_scene_diff.fixed_frame_transforms:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _v321 = val1.transform
        _v322 = _v321.translation
        _x = _v322
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v323 = _v321.rotation
        _x = _v323
        buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
      length = len(self.action_goal.goal.planning_options.planning_scene_diff.allowed_collision_matrix.entry_names)
      buff.write(_struct_I.pack(length))
      ...
      for val1 in self.action_result.result.trajectory_start.attached_collision_objects:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v340.primitives)
        buff.write(_struct_I.pack(length))
        for val3 in _v340.primitives:
          _x = val3.type
          buff.write(_get_struct_B().pack(_x))
          length = len(val3.dimensions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(val3.dimensions.tostring())
        length = len(_v340.primitive_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v340.primitive_poses:
          _v344 = val3.position
          _x = _v344
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v345
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v340.meshes)
        buff.write(_struct_I.pack(length))
        for val3 in _v340.meshes:
          length = len(val3.triangles)
          buff.write(_struct_I.pack(length))
          for val4 in val3.triangles:
            buff.write(val4.vertex_indices.tostring())
          ...
          for val4 in val3.vertices:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v340.mesh_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v340.mesh_poses:
          _v346 = val3.position
          _x = _v346
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v347
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v340.planes)
        buff.write(_struct_I.pack(length))
        for val3 in _v340.planes:
          buff.write(val3.coef.tostring())
        length = len(_v340.plane_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v340.plane_poses:
          _v348 = val3.position
          _x = _v348
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v350.joint_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v350.joint_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v350.points)
        buff.write(_struct_I.pack(length))
        for val3 in _v350.points:
          length = len(val3.positions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(val3.positions.tostring())
      ...
      for val1 in self.action_result.result.trajectory_stages:
        ...
        for val3 in _v354.points:
          ...
          _x = _v357
          buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
        _v358 = val1.multi_dof_joint_trajectory
        _v359 = _v358.header
        _x = _v359.seq
        buff.write(_get_struct_I().pack(_x))
        _v360 = _v359.stamp
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v358.joint_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v358.joint_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1.id = str[start:end]
        _v370 = val1.pre_grasp_posture
        _v371 = _v370.header
        start = end
        end += 4
        (_v371.seq,) = _get_struct_I().unpack(str[start:end])
        _v372 = _v371.stamp
        _x = _v372
        start = end
        end += 8
        ...
        if python3:
          _v371.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v371.frame_id = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v370.joint_names = []
        ...
        for i in range(0, length):
          ...
          (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
          _v370.points.append(val3)
        _v374 = val1.grasp_posture
        _v375 = _v374.header
        start = end
        end += 4
        ...
        for i in range(0, length):
          ...
          val3.effort = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
          _v377 = val3.time_from_start
          _x = _v377
          start = end
          end += 8
          (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
          _v374.points.append(val3)
        _v378 = val1.grasp_pose
        _v379 = _v378.header
        start = end
        end += 4
        (_v379.seq,) = _get_struct_I().unpack(str[start:end])
        _v380 = _v379.stamp
        _x = _v380
        start = end
        end += 8
        ...
        if python3:
          _v379.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (val1.grasp_quality,) = _get_struct_d().unpack(str[start:end])
        _v384 = val1.pre_grasp_approach
        _v385 = _v384.direction
        _v386 = _v385.header
        start = end
        end += 4
        ...
        (_x.desired_distance, _x.min_distance,) = _get_struct_2f().unpack(str[start:end])
        _v389 = val1.post_grasp_retreat
        _v390 = _v389.direction
        _v391 = _v390.header
        start = end
        end += 4
        ...
        (_x.desired_distance, _x.min_distance,) = _get_struct_2f().unpack(str[start:end])
        _v394 = val1.post_place_retreat
        _v395 = _v394.direction
        _v396 = _v395.header
        start = end
        end += 4
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1.link_name = str[start:end]
        _v401 = val1.target_point_offset
        _x = _v401
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v402 = val1.constraint_region
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v402.primitives = []
        for i in range(0, length):
          ...
          _v402.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v402.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v403 = val3.position
          _x = _v403
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v402.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v402.meshes = []
      ...
      for i in range(0, length):
        ...
        (_v407.seq,) = _get_struct_I().unpack(str[start:end])
        _v408 = _v407.stamp
        _x = _v408
        start = end
        end += 8
        ...
        if python3:
          _v407.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v407.frame_id = str[start:end]
        _v409 = val1.orientation
        _x = _v409
        start = end
        end += 32
        (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        if python3:
          _v428.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v428.id = str[start:end]
        _v431 = _v428.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          _v431.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v431.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        for i in range(0, length):
          ...
          val3.dimensions = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
          _v428.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v428.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v432 = val3.position
          _x = _v432
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v428.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v428.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v435 = val3.orientation
          _x = _v435
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v428.mesh_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v428.planes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v437 = val3.orientation
          _x = _v437
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v428.plane_poses.append(val3)
        start = end
        end += 1
        (_v428.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
        for i in range(0, length):
          ...
          if python3:
            ...
            val2 = str[start:end]
          val1.touch_links.append(val2)
        _v438 = val1.detach_posture
        _v439 = _v438.header
        start = end
        end += 4
        (_v439.seq,) = _get_struct_I().unpack(str[start:end])
        _v440 = _v439.stamp
        _x = _v440
        start = end
        end += 8
        ...
        if python3:
          _v439.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
      ...
      for i in range(0, length):
        ...
        (_v442.seq,) = _get_struct_I().unpack(str[start:end])
        _v443 = _v442.stamp
        _x = _v443
        start = end
        end += 8
        ...
        if python3:
          _v442.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v442.frame_id = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          ...
          val1.child_frame_id = str[start:end]
        _v444 = val1.transform
        _v445 = _v444.translation
        _x = _v445
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v446 = _v444.rotation
        _x = _v446
        start = end
        end += 32
        (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        if python3:
          _v450.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v450.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v450.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v450.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.primitives = []
      ...
      for i in range(0, length):
        ...
        if python3:
          _v463.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v463.id = str[start:end]
        _v466 = _v463.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        for i in range(0, length):
          ...
          val3.dimensions = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
          _v463.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v463.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v467 = val3.position
          _x = _v467
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v468 = val3.orientation
          _x = _v468
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v463.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v463.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v470 = val3.orientation
          _x = _v470
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v463.mesh_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v463.planes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v472 = val3.orientation
          _x = _v472
          start = end
          end += 32
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v463.plane_poses.append(val3)
        start = end
        end += 1
        (_v463.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
        ...
        if python3:
          _v474.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
