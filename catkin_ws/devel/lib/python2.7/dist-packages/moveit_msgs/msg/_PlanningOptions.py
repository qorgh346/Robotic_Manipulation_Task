...
"""autogenerated by genpy from moveit_msgs/PlanningOptions.msg. Do not edit."""
import codecs
import sys
...
class PlanningOptions(genpy.Message):
  _md5sum = "3934e50ede2ecea03e532aade900ab50"
  _type = "moveit_msgs/PlanningOptions"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       planning_scene_diff,plan_only,look_around,look_around_attempts,max_safe_execution_cost,replan,replan_attempts,replan_delay
  ...
  def serialize(self, buff):
    ...
    """
    try:
      _x = self.planning_scene_diff.name
      length = len(_x)
      ...
      _x = self
      buff.write(_get_struct_3I().pack(_x.planning_scene_diff.robot_state.joint_state.header.seq, _x.planning_scene_diff.robot_state.joint_state.header.stamp.secs, _x.planning_scene_diff.robot_state.joint_state.header.stamp.nsecs))
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.planning_scene_diff.robot_state.joint_state.position))
      length = len(self.planning_scene_diff.robot_state.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.planning_scene_diff.robot_state.joint_state.velocity))
      length = len(self.planning_scene_diff.robot_state.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.planning_scene_diff.robot_state.joint_state.effort))
      _x = self
      buff.write(_get_struct_3I().pack(_x.planning_scene_diff.robot_state.multi_dof_joint_state.header.seq, _x.planning_scene_diff.robot_state.multi_dof_joint_state.header.stamp.secs, _x.planning_scene_diff.robot_state.multi_dof_joint_state.header.stamp.nsecs))
      _x = self.planning_scene_diff.robot_state.multi_dof_joint_state.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      for val1 in self.planning_scene_diff.robot_state.multi_dof_joint_state.joint_names:
        ...
        if python3 or type(val1) == unicode:
          ...
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      length = len(self.planning_scene_diff.robot_state.multi_dof_joint_state.transforms)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene_diff.robot_state.multi_dof_joint_state.transforms:
      ...
      length = len(self.planning_scene_diff.robot_state.multi_dof_joint_state.twist)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene_diff.robot_state.multi_dof_joint_state.twist:
        _v3 = val1.linear
        _x = _v3
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v4 = val1.angular
        _x = _v4
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.planning_scene_diff.robot_state.multi_dof_joint_state.wrench)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene_diff.robot_state.multi_dof_joint_state.wrench:
        _v5 = val1.force
        _x = _v5
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v6 = val1.torque
        _x = _v6
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.planning_scene_diff.robot_state.attached_collision_objects)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene_diff.robot_state.attached_collision_objects:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      _x = self.planning_scene_diff.robot_state.is_diff
      buff.write(_get_struct_B().pack(_x))
      _x = self.planning_scene_diff.robot_model_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      for val1 in self.planning_scene_diff.fixed_frame_transforms:
        ...
        _x = _v25
        buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
      length = len(self.planning_scene_diff.allowed_collision_matrix.entry_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene_diff.allowed_collision_matrix.entry_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      length = len(self.planning_scene_diff.allowed_collision_matrix.entry_values)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene_diff.allowed_collision_matrix.entry_values:
        length = len(val1.enabled)
        buff.write(_struct_I.pack(length))
        pattern = '<%sB'%length
        buff.write(struct.Struct(pattern).pack(*val1.enabled))
      length = len(self.planning_scene_diff.allowed_collision_matrix.default_entry_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene_diff.allowed_collision_matrix.default_entry_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      length = len(self.planning_scene_diff.allowed_collision_matrix.default_entry_values)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.Struct(pattern).pack(*self.planning_scene_diff.allowed_collision_matrix.default_entry_values))
      ...
      for val1 in self.planning_scene_diff.link_padding:
        ...
        _x = val1.padding
        buff.write(_get_struct_d().pack(_x))
      length = len(self.planning_scene_diff.link_scale)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene_diff.link_scale:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        _x = val1.scale
        buff.write(_get_struct_d().pack(_x))
      length = len(self.planning_scene_diff.object_colors)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene_diff.object_colors:
        _x = val1.id
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      length = len(self.planning_scene_diff.world.collision_objects)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene_diff.world.collision_objects:
        _v27 = val1.header
        _x = _v27.seq
        buff.write(_get_struct_I().pack(_x))
        _v28 = _v27.stamp
        ...
        buff.write(_get_struct_b().pack(_x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.planning_scene_diff.world.octomap.header.seq, _x.planning_scene_diff.world.octomap.header.stamp.secs, _x.planning_scene_diff.world.octomap.header.stamp.nsecs))
      _x = self.planning_scene_diff.world.octomap.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7d3I().pack(_x.planning_scene_diff.world.octomap.origin.position.x, _x.planning_scene_diff.world.octomap.origin.position.y, _x.planning_scene_diff.world.octomap.origin.position.z, _x.planning_scene_diff.world.octomap.origin.orientation.x, _x.planning_scene_diff.world.octomap.origin.orientation.y, _x.planning_scene_diff.world.octomap.origin.orientation.z, _x.planning_scene_diff.world.octomap.origin.orientation.w, _x.planning_scene_diff.world.octomap.octomap.header.seq, _x.planning_scene_diff.world.octomap.octomap.header.stamp.secs, _x.planning_scene_diff.world.octomap.octomap.header.stamp.nsecs))
      _x = self.planning_scene_diff.world.octomap.octomap.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.planning_scene_diff.world.octomap.octomap.binary
      buff.write(_get_struct_B().pack(_x))
      _x = self.planning_scene_diff.world.octomap.octomap.id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.planning_scene_diff.world.octomap.octomap.resolution
      buff.write(_get_struct_d().pack(_x))
      length = len(self.planning_scene_diff.world.octomap.octomap.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sb'%length
      buff.write(struct.Struct(pattern).pack(*self.planning_scene_diff.world.octomap.octomap.data))
      _x = self
      buff.write(_get_struct_3BidBid().pack(_x.planning_scene_diff.is_diff, _x.plan_only, _x.look_around, _x.look_around_attempts, _x.max_safe_execution_cost, _x.replan, _x.replan_attempts, _x.replan_delay))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.planning_scene_diff.name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.planning_scene_diff.name = str[start:end]
      _x = self
      start = end
      end += 12
      (_x.planning_scene_diff.robot_state.joint_state.header.seq, _x.planning_scene_diff.robot_state.joint_state.header.stamp.secs, _x.planning_scene_diff.robot_state.joint_state.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.planning_scene_diff.robot_state.joint_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.planning_scene_diff.robot_state.joint_state.position = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.planning_scene_diff.robot_state.joint_state.velocity = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.planning_scene_diff.robot_state.joint_state.effort = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
      (_x.planning_scene_diff.robot_state.multi_dof_joint_state.header.seq, _x.planning_scene_diff.robot_state.multi_dof_joint_state.header.stamp.secs, _x.planning_scene_diff.robot_state.multi_dof_joint_state.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.planning_scene_diff.robot_state.multi_dof_joint_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.planning_scene_diff.robot_state.multi_dof_joint_state.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.planning_scene_diff.robot_state.multi_dof_joint_state.transforms = []
      for i in range(0, length):
        ...
        self.planning_scene_diff.robot_state.multi_dof_joint_state.transforms.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.planning_scene_diff.robot_state.multi_dof_joint_state.twist = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.planning_scene_diff.robot_state.multi_dof_joint_state.twist.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.planning_scene_diff.robot_state.multi_dof_joint_state.wrench = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.planning_scene_diff.robot_state.multi_dof_joint_state.wrench.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.planning_scene_diff.robot_state.attached_collision_objects = []
      for i in range(0, length):
        ...
        if python3:
          _v42.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v45.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v45.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v42.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
        ...
        self.planning_scene_diff.robot_state.attached_collision_objects.append(val1)
      start = end
      end += 1
      (self.planning_scene_diff.robot_state.is_diff,) = _get_struct_B().unpack(str[start:end])
      self.planning_scene_diff.robot_state.is_diff = bool(self.planning_scene_diff.robot_state.is_diff)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.planning_scene_diff.robot_model_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.planning_scene_diff.robot_model_name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.planning_scene_diff.allowed_collision_matrix.entry_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.planning_scene_diff.allowed_collision_matrix.entry_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.planning_scene_diff.allowed_collision_matrix.entry_values = []
      for i in range(0, length):
        ...
        self.planning_scene_diff.allowed_collision_matrix.entry_values.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.planning_scene_diff.allowed_collision_matrix.default_entry_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.planning_scene_diff.allowed_collision_matrix.default_entry_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.planning_scene_diff.allowed_collision_matrix.default_entry_values = s.unpack(str[start:end])
      self.planning_scene_diff.allowed_collision_matrix.default_entry_values = list(map(bool, self.planning_scene_diff.allowed_collision_matrix.default_entry_values))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.planning_scene_diff.link_scale = []
      for i in range(0, length):
        ...
        self.planning_scene_diff.link_scale.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.planning_scene_diff.object_colors = []
      for i in range(0, length):
        ...
        self.planning_scene_diff.object_colors.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.planning_scene_diff.world.collision_objects = []
      for i in range(0, length):
        ...
        if python3:
          _v64.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v64.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        self.planning_scene_diff.world.collision_objects.append(val1)
      _x = self
      start = end
      end += 12
      (_x.planning_scene_diff.world.octomap.header.seq, _x.planning_scene_diff.world.octomap.header.stamp.secs, _x.planning_scene_diff.world.octomap.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.planning_scene_diff.world.octomap.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.planning_scene_diff.world.octomap.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 68
      (_x.planning_scene_diff.world.octomap.origin.position.x, _x.planning_scene_diff.world.octomap.origin.position.y, _x.planning_scene_diff.world.octomap.origin.position.z, _x.planning_scene_diff.world.octomap.origin.orientation.x, _x.planning_scene_diff.world.octomap.origin.orientation.y, _x.planning_scene_diff.world.octomap.origin.orientation.z, _x.planning_scene_diff.world.octomap.origin.orientation.w, _x.planning_scene_diff.world.octomap.octomap.header.seq, _x.planning_scene_diff.world.octomap.octomap.header.stamp.secs, _x.planning_scene_diff.world.octomap.octomap.header.stamp.nsecs,) = _get_struct_7d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.planning_scene_diff.world.octomap.octomap.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.planning_scene_diff.world.octomap.octomap.header.frame_id = str[start:end]
      start = end
      end += 1
      (self.planning_scene_diff.world.octomap.octomap.binary,) = _get_struct_B().unpack(str[start:end])
      self.planning_scene_diff.world.octomap.octomap.binary = bool(self.planning_scene_diff.world.octomap.octomap.binary)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.planning_scene_diff.world.octomap.octomap.id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.planning_scene_diff.world.octomap.octomap.id = str[start:end]
      start = end
      end += 8
      (self.planning_scene_diff.world.octomap.octomap.resolution,) = _get_struct_d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sb'%length
      ...
      self.planning_scene_diff.world.octomap.octomap.data = s.unpack(str[start:end])
      _x = self
      start = end
      end += 28
      (_x.planning_scene_diff.is_diff, _x.plan_only, _x.look_around, _x.look_around_attempts, _x.max_safe_execution_cost, _x.replan, _x.replan_attempts, _x.replan_delay,) = _get_struct_3BidBid().unpack(str[start:end])
      self.planning_scene_diff.is_diff = bool(self.planning_scene_diff.is_diff)
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(self.planning_scene_diff.allowed_collision_matrix.default_entry_values.tostring())
      length = len(self.planning_scene_diff.link_padding)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene_diff.link_padding:
        _x = val1.link_name
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sb'%length
      buff.write(self.planning_scene_diff.world.octomap.octomap.data.tostring())
      _x = self
      buff.write(_get_struct_3BidBid().pack(_x.planning_scene_diff.is_diff, _x.plan_only, _x.look_around, _x.look_around_attempts, _x.max_safe_execution_cost, _x.replan, _x.replan_attempts, _x.replan_delay))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v112.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v112.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      self.planning_scene_diff.allowed_collision_matrix.default_entry_values = numpy.frombuffer(str[start:end], dtype=numpy.bool, count=length)
      self.planning_scene_diff.allowed_collision_matrix.default_entry_values = list(map(bool, self.planning_scene_diff.allowed_collision_matrix.default_entry_values))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      self.planning_scene_diff.world.octomap.octomap.data = numpy.frombuffer(str[start:end], dtype=numpy.int8, count=length)
      _x = self
      start = end
      end += 28
      (_x.planning_scene_diff.is_diff, _x.plan_only, _x.look_around, _x.look_around_attempts, _x.max_safe_execution_cost, _x.replan, _x.replan_attempts, _x.replan_delay,) = _get_struct_3BidBid().unpack(str[start:end])
