  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v123.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v126.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v126.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v123.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
