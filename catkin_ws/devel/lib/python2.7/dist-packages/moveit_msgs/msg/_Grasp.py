...
"""autogenerated by genpy from moveit_msgs/Grasp.msg. Do not edit."""
import codecs
import sys
...
class Grasp(genpy.Message):
  _md5sum = "e26c8fb64f589c33c5d5e54bd7b5e4cb"
  _type = "moveit_msgs/Grasp"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# This message contains a description of a grasp that would be used
...
float64 z"""
  ...
  _slot_types = ['string','trajectory_msgs/JointTrajectory','trajectory_msgs/JointTrajectory','geometry_msgs/PoseStamped','float64','moveit_msgs/GripperTranslation','moveit_msgs/GripperTranslation','moveit_msgs/GripperTranslation','float32','string[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.pre_grasp_posture is None:
        self.pre_grasp_posture = trajectory_msgs.msg.JointTrajectory()
      if self.grasp_posture is None:
        self.grasp_posture = trajectory_msgs.msg.JointTrajectory()
      if self.grasp_pose is None:
        self.grasp_pose = geometry_msgs.msg.PoseStamped()
      if self.grasp_quality is None:
        self.grasp_quality = 0.
      if self.pre_grasp_approach is None:
        self.pre_grasp_approach = moveit_msgs.msg.GripperTranslation()
      if self.post_grasp_retreat is None:
        self.post_grasp_retreat = moveit_msgs.msg.GripperTranslation()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.pre_grasp_posture.joint_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.pre_grasp_posture.joint_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      length = len(self.pre_grasp_posture.points)
      buff.write(_struct_I.pack(length))
      for val1 in self.pre_grasp_posture.points:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.grasp_posture.joint_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.grasp_posture.joint_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      length = len(self.grasp_posture.points)
      buff.write(_struct_I.pack(length))
      for val1 in self.grasp_posture.points:
        length = len(val1.positions)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.Struct(pattern).pack(*val1.positions))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3d2f3I().pack(_x.pre_grasp_approach.direction.vector.x, _x.pre_grasp_approach.direction.vector.y, _x.pre_grasp_approach.direction.vector.z, _x.pre_grasp_approach.desired_distance, _x.pre_grasp_approach.min_distance, _x.post_grasp_retreat.direction.header.seq, _x.post_grasp_retreat.direction.header.stamp.secs, _x.post_grasp_retreat.direction.header.stamp.nsecs))
      _x = self.post_grasp_retreat.direction.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3d2f3I().pack(_x.post_grasp_retreat.direction.vector.x, _x.post_grasp_retreat.direction.vector.y, _x.post_grasp_retreat.direction.vector.z, _x.post_grasp_retreat.desired_distance, _x.post_grasp_retreat.min_distance, _x.post_place_retreat.direction.header.seq, _x.post_place_retreat.direction.header.stamp.secs, _x.post_place_retreat.direction.header.stamp.nsecs))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3d3f().pack(_x.post_place_retreat.direction.vector.x, _x.post_place_retreat.direction.vector.y, _x.post_place_retreat.direction.vector.z, _x.post_place_retreat.desired_distance, _x.post_place_retreat.min_distance, _x.max_contact_force))
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.pre_grasp_posture.joint_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.pre_grasp_posture.points = []
      for i in range(0, length):
        ...
        self.pre_grasp_posture.points.append(val1)
      _x = self
      start = end
      end += 12
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.grasp_posture.joint_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.grasp_posture.points = []
      for i in range(0, length):
        val1 = trajectory_msgs.msg.JointTrajectoryPoint()
        start = end
        end += 4
        ...
        (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
        self.grasp_posture.points.append(val1)
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.pre_grasp_approach.direction.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.pre_grasp_approach.direction.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 44
      (_x.pre_grasp_approach.direction.vector.x, _x.pre_grasp_approach.direction.vector.y, _x.pre_grasp_approach.direction.vector.z, _x.pre_grasp_approach.desired_distance, _x.pre_grasp_approach.min_distance, _x.post_grasp_retreat.direction.header.seq, _x.post_grasp_retreat.direction.header.stamp.secs, _x.post_grasp_retreat.direction.header.stamp.nsecs,) = _get_struct_3d2f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.post_grasp_retreat.direction.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.post_grasp_retreat.direction.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 44
      (_x.post_grasp_retreat.direction.vector.x, _x.post_grasp_retreat.direction.vector.y, _x.post_grasp_retreat.direction.vector.z, _x.post_grasp_retreat.desired_distance, _x.post_grasp_retreat.min_distance, _x.post_place_retreat.direction.header.seq, _x.post_place_retreat.direction.header.stamp.secs, _x.post_place_retreat.direction.header.stamp.nsecs,) = _get_struct_3d2f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.post_place_retreat.direction.vector.x, _x.post_place_retreat.direction.vector.y, _x.post_place_retreat.direction.vector.z, _x.post_place_retreat.desired_distance, _x.post_place_retreat.min_distance, _x.max_contact_force,) = _get_struct_3d3f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.allowed_touch_objects = []
