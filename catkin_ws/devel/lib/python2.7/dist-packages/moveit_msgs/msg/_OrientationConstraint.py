...
class OrientationConstraint(genpy.Message):
  _md5sum = "ab5cefb9bc4c0089620f5eb4caf4e59a"
...
float64 w
"""
  __slots__ = ['header','orientation','link_name','absolute_x_axis_tolerance','absolute_y_axis_tolerance','absolute_z_axis_tolerance','weight']
  _slot_types = ['std_msgs/Header','geometry_msgs/Quaternion','string','float64','float64','float64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,orientation,link_name,absolute_x_axis_tolerance,absolute_y_axis_tolerance,absolute_z_axis_tolerance,weight
