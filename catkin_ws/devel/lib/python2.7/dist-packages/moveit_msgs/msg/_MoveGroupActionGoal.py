...
class MoveGroupActionGoal(genpy.Message):
  _md5sum = "df11ac1a643d87b6e6a6fe5af1823709"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.goal.request.workspace_parameters.header.seq, _x.goal.request.workspace_parameters.header.stamp.secs, _x.goal.request.workspace_parameters.header.stamp.nsecs))
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.goal.request.start_state.joint_state.position))
      length = len(self.goal.request.start_state.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.goal.request.start_state.joint_state.velocity))
      length = len(self.goal.request.start_state.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.goal.request.start_state.joint_state.effort))
      _x = self
      buff.write(_get_struct_3I().pack(_x.goal.request.start_state.multi_dof_joint_state.header.seq, _x.goal.request.start_state.multi_dof_joint_state.header.stamp.secs, _x.goal.request.start_state.multi_dof_joint_state.header.stamp.nsecs))
      ...
      _x = self.goal.request.start_state.is_diff
      buff.write(_get_struct_B().pack(_x))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_i3d().pack(_x.goal.request.num_planning_attempts, _x.goal.request.allowed_planning_time, _x.goal.request.max_velocity_scaling_factor, _x.goal.request.max_acceleration_scaling_factor))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.request.workspace_parameters.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.goal.request.start_state.joint_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.goal.request.start_state.joint_state.position = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.goal.request.start_state.joint_state.velocity = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.goal.request.start_state.joint_state.effort = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.goal.request.start_state.multi_dof_joint_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v131.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v131.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      if python3:
        self.goal.request.path_constraints.name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.goal.request.planner_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.goal.request.group_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v220.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v223.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v223.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v220.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      for i in range(0, length):
        ...
        (_v234.seq,) = _get_struct_I().unpack(str[start:end])
        _v235 = _v234.stamp
        _x = _v235
        start = end
        end += 8
        ...
        if python3:
          _v234.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v240.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v242.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v242.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v379.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v382.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v382.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v379.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          (_v401.seq,) = _get_struct_I().unpack(str[start:end])
          _v402 = _v401.stamp
          _x = _v402
          start = end
          end += 8
          ...
          if python3:
            _v401.frame_id = str[start:end].decode('utf-8', 'rosmsg')
          else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v424.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            _v447.frame_id = str[start:end].decode('utf-8', 'rosmsg')
          else:
        ...
        for i in range(0, length):
          ...
          (_v457.seq,) = _get_struct_I().unpack(str[start:end])
          _v458 = _v457.stamp
          _x = _v458
          start = end
          end += 8
          ...
          if python3:
            _v457.frame_id = str[start:end].decode('utf-8', 'rosmsg')
          else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v468.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v471.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v471.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v468.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
