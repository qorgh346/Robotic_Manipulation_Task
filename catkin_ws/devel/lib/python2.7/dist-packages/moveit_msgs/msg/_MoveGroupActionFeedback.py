...
"""autogenerated by genpy from moveit_msgs/MoveGroupActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class MoveGroupActionFeedback(genpy.Message):
  _md5sum = "12232ef97486c7962f264c105aae2958"
  _type = "moveit_msgs/MoveGroupActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','moveit_msgs/MoveGroupFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveGroupActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = moveit_msgs.msg.MoveGroupFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = moveit_msgs.msg.MoveGroupFeedback()
