...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.attached_object_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      (self.place_eef,) = _get_struct_B().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        if python3:
          _v128.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v131.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v131.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        (_v128.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
