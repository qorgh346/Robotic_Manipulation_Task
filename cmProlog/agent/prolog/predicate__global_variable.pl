...
:- nb_setval(predicate__empty_hand_intersectPer_threshold, 0.02).				%empty_hand
:- nb_setval(predicate__overlap_hand_intersectPer_threshold, 0.002).				%overlap_hand
...
:- nb_setval(predicate__joint_check_joint_angle_threshold, 2.0).				%joint_check
